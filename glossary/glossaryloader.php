...
?>
<head>
	<title><?php echo $GLOBALS['DEFAULT_TITLE']; ?> Glossary Term Uploader</title>
    <meta name="description" content="Upload glossary terms for the <?php echo $GLOBALS['DEFAULT_TITLE']; ?> portal">
