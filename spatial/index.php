...
<html lang="<?php echo $GLOBALS['DEFAULT_LANG']; ?>">
    ...
    ?>
    <head>
        <title><?php echo $GLOBALS['DEFAULT_TITLE']; ?> Spatial Analysis Module</title>
        <meta name="description" content="Spatial analysis module for the <?php echo $GLOBALS['DEFAULT_TITLE']; ?> portal">
