...
?>
<head>
	<title><?php echo $GLOBALS['DEFAULT_TITLE']; ?> Character Heading Editor</title>
    <meta name="description" content="Identification key character heading editor for the <?php echo $GLOBALS['DEFAULT_TITLE']; ?> portal">
