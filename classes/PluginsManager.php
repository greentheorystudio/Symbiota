...
class PluginsManager {
	...
	public function setShowHtml($imageHtml,$width,$interval): string
	{
		...
		$html .= "src:url('".$CLIENT_ROOT."/css/images/fontawesome-webfont.eot?v=3.0.1');";
		$html .= "src:url('".$CLIENT_ROOT."/css/images/fontawesome-webfont.eot?#iefix&v=3.0.1') format('embedded-opentype'),";
		$html .= "url('".$CLIENT_ROOT."/css/images/fontawesome-webfont.woff?v=3.0.1') format('woff'),";
		$html .= "url('".$CLIENT_ROOT."/css/images/fontawesome-webfont.ttf?v=3.0.1') format('truetype');";
		...
		$html .= 'background-image: url('.$CLIENT_ROOT.'/css/images/btns-next-prev.png);';
	...
	public function createQuickSearch($buttonText,$searchText = '',$placeholderText = ''): string
	{
        ...
        return <<<EOD
            ...
            <script type='text/javascript'>
                if(!window.jQuery){
                    ...
                    jqresource.onload = function(){
                        ...
                        jquiresource.src = "$CLIENT_ROOT/js/jquery-ui.js";
                    ...
                    $(document).ready(function() {
                        ...
                        .autocomplete({
                            source: function( request, response ) {
                                $.getJSON( "$CLIENT_ROOT/collections/rpc/taxalist.php", {
                                    term: extractLast( request.term ), t: function() {
                                        return document.quicksearch.taxon.value;
                                    }
                                }, response );
                            },
            ...
            <div id="quicksearchtext" ><b>$searchText</b></div>
            <input type="text" name="taxon" placeholder="$placeholderText" id="quicksearchtaxon" title="Enter taxon name here." />
