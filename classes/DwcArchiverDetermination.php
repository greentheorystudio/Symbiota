...
class DwcArchiverDetermination{
	...
	public static function getDeterminationArr($schemaType,$extended): array
    {
		...
		$termArr['identifiedBy'] = 'https://dwc.tdwg.org/terms/#identifiedBy';
		$fieldArr['identifiedBy'] = 'd.identifiedBy';
		$termArr['identifiedByID'] = '';
		$fieldArr['identifiedByID'] = 'd.idbyid';
		$termArr['dateIdentified'] = 'https://dwc.tdwg.org/terms/#dateIdentified';
		$fieldArr['dateIdentified'] = 'd.dateIdentified';
		$termArr['identificationQualifier'] = 'https://dwc.tdwg.org/terms/#identificationQualifier';
		$fieldArr['identificationQualifier'] = 'd.identificationQualifier';
		$termArr['scientificName'] = 'https://dwc.tdwg.org/terms/#scientificName';
		$fieldArr['scientificName'] = 'd.sciName AS scientificName';
		$termArr['tidInterpreted'] = '';
		$fieldArr['tidInterpreted'] = 'd.tidinterpreted';
		$termArr['identificationIsCurrent'] = '';
		$fieldArr['identificationIsCurrent'] = 'd.iscurrent';
		$termArr['scientificNameAuthorship'] = 'https://dwc.tdwg.org/terms/#scientificNameAuthorship';
		$fieldArr['scientificNameAuthorship'] = 'd.scientificNameAuthorship';
		$termArr['genus'] = 'https://dwc.tdwg.org/terms/#genus';
		$fieldArr['genus'] = 'CONCAT_WS(" ",t.unitind1,t.unitname1) AS genus';
		$termArr['specificEpithet'] = 'https://dwc.tdwg.org/terms/#specificEpithet';
		$fieldArr['specificEpithet'] = 'CONCAT_WS(" ",t.unitind2,t.unitname2) AS specificEpithet';
		$termArr['taxonRank'] = 'https://dwc.tdwg.org/terms/#taxonRank';
		$fieldArr['taxonRank'] = 't.unitind3 AS taxonRank';
		$termArr['infraspecificEpithet'] = 'https://dwc.tdwg.org/terms/#infraspecificEpithet';
		$fieldArr['infraspecificEpithet'] = 't.unitname3 AS infraspecificEpithet';
		$termArr['identificationReferences'] = 'https://dwc.tdwg.org/terms/#identificationReferences';
		$fieldArr['identificationReferences'] = 'd.identificationReferences';
		$termArr['identificationRemarks'] = 'https://dwc.tdwg.org/terms/#identificationRemarks';
