...
class DwcArchiverDetermination{
	...
	public static function getDeterminationArr($schemaType,$extended): array
    {
		...
		$termArr['identifiedBy'] = 'https://dwc.tdwg.org/list/#dwc_identifiedBy';
		$fieldArr['identifiedBy'] = 'd.identifiedBy';
		$termArr['identifiedByID'] = '';
		$fieldArr['identifiedByID'] = 'd.idbyid';
		$termArr['dateIdentified'] = 'https://dwc.tdwg.org/list/#dwc_dateIdentified';
		$fieldArr['dateIdentified'] = 'd.dateIdentified';
		$termArr['identificationQualifier'] = 'https://dwc.tdwg.org/list/#dwc_identificationQualifier';
		$fieldArr['identificationQualifier'] = 'd.identificationQualifier';
		$termArr['scientificName'] = 'https://dwc.tdwg.org/list/#dwc_scientificName';
		...
		$termArr['scientificNameAuthorship'] = 'https://dwc.tdwg.org/list/#dwc_scientificNameAuthorship';
		$fieldArr['scientificNameAuthorship'] = 'd.scientificNameAuthorship';
		$termArr['genus'] = 'https://dwc.tdwg.org/list/#dwc_genus';
		$fieldArr['genus'] = 'CONCAT_WS(" ",t.unitind1,t.unitname1) AS genus';
		$termArr['specificEpithet'] = 'https://dwc.tdwg.org/list/#dwc_specificEpithet';
		$fieldArr['specificEpithet'] = 'CONCAT_WS(" ",t.unitind2,t.unitname2) AS specificEpithet';
		$termArr['taxonRank'] = 'https://dwc.tdwg.org/list/#dwc_taxonRank';
		$fieldArr['taxonRank'] = 't.unitind3 AS taxonRank';
		$termArr['infraspecificEpithet'] = 'https://dwc.tdwg.org/list/#dwc_infraspecificEpithet';
		$fieldArr['infraspecificEpithet'] = 't.unitname3 AS infraspecificEpithet';
		$termArr['identificationReferences'] = 'https://dwc.tdwg.org/list/#dwc_identificationReferences';
		$fieldArr['identificationReferences'] = 'd.identificationReferences';
		$termArr['identificationRemarks'] = 'https://dwc.tdwg.org/list/#dwc_identificationRemarks';
		$fieldArr['identificationRemarks'] = 'd.identificationRemarks';
		$termArr['recordId'] = 'https://biokic.github.io/symbiota-docs/editor/edit/fields/';
		$fieldArr['recordId'] = 'g.guid AS recordId';
		$termArr['modified'] = 'https://www.dublincore.org/specifications/dublin-core/dcmi-terms/#modified';
