                ...
                const navBarData = Vue.ref([
                    ...
                    },
                    {
                        ...
                        subItems: [
                            ...
                            {url: CLIENT_ROOT + '/collections/occurrenceNavigator.php?interface=spatial', label: 'Map Occurrence Search', newTab: true},
                            {url: CLIENT_ROOT + '/collections/occurrenceNavigator.php?interface=list', label: 'Text Occurrence Search'},
                    ...
                    },
                    {
                        label: 'Tutorials',
                        subItems: [
                            {url: CLIENT_ROOT + '/collections/occurrenceNavigator.php?interface=spatial', label: 'Map Search Tutorial', newTab: true},
