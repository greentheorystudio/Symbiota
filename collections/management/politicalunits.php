								...
								foreach($badCountryArr as $countryName => $countryCnt){
									...
									<div style="margin-left:15px;">
										<form name="countrycleanform" method="post" action="politicalunits.php" onsubmit="return verifyCountryCleanForm(this)">
											...
											<a href='../occurrenceNavigator.php?interface=occurrence&collid=<?php echo $collid; ?>&starr={"collid":<?php echo $collid; ?>,"country":"<?php echo $countryName; ?>"}' target="_blank"><i style="height:15px;width:15px;" class="far fa-edit"></i></a>
								...
								foreach($badCountryArr as $stateName => $stateCnt){
									...
									<div style="margin-left:15px;">
										<form name="nullcountryform" method="post" action="politicalunits.php" onsubmit="return verifyNullCountryForm(this)">
											...
											<a href='../occurrenceNavigator.php?interface=occurrence&collid=<?php echo $collid; ?>&starr={"collid":<?php echo $collid; ?>,"advanced":[{"concatenator":null,"openParens":null,"field":"country","dataType":null,"operator":"IS NULL","value":null,"closeParens":null}],"state":"<?php echo $stateName; ?>"}' target="_blank"><i style="height:15px;width:15px;" class="far fa-edit"></i></a>
									...
									foreach($stateArr as $stateName => $stateCnt){
										...
										<div style="margin-left:15px;">
											<form name="statecleanform" method="post" action="politicalunits.php" onsubmit="return verifyStateCleanForm(this)">
												<b><?php echo $stateName; ?></b>
												<?php echo ' <span title="Number of Occurrences">('.$stateCnt.')</span>'; ?>
												<a href='../occurrenceNavigator.php?interface=occurrence&collid=<?php echo $collid; ?>&starr={"collid":<?php echo $collid; ?>,"state":"<?php echo $stateName; ?>"}' target="_blank"><i style="height:15px;width:15px;" class="far fa-edit"></i></a>
												<?php 
										...
										foreach($countyArr as $countyName => $countyCnt){
											...
											<div style="margin-left:30px;">
												<form name="countycleanform" method="post" action="politicalunits.php" onsubmit="return verifyCountyCleanForm(this)">
													<b><?php echo $countyName; ?></b>
													<?php echo ' <span title="Number of Occurrences">('.$countyCnt.')</span>'; ?>
													<a href='../occurrenceNavigator.php?interface=occurrence&collid=<?php echo $collid; ?>&starr={"collid":<?php echo $collid; ?>,"county":"<?php echo $countyName; ?>"}' target="_blank"><i style="height:15px;width:15px;" class="far fa-edit"></i></a>
													<?php 
