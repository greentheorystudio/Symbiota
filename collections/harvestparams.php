...
<html lang="<?php echo $GLOBALS['DEFAULT_LANG']; ?>">
    ...
    <head>
        ...
        <script src="<?php echo $GLOBALS['CLIENT_ROOT']; ?>/js/collections.harvestparams.js?ver=20230103" type="text/javascript"></script>
    ...
    <body>
        ...
        <script src="<?php echo $GLOBALS['CLIENT_ROOT']; ?>/components/spatial/spatialAnalysisPopup.js" type="text/javascript"></script>
        <script>
