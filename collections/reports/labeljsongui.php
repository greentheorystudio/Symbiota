...
?>
<head>
    <title><?php echo $GLOBALS['DEFAULT_TITLE']; ?> Label Editor</title>
    <meta name="description" content="Label editor for collection occurrence records in the <?php echo $GLOBALS['DEFAULT_TITLE']; ?> portal">
    ...
    <link href="<?php echo $GLOBALS['CLIENT_ROOT']; ?>/css/jsongui.css?ver=20221204" rel="stylesheet" type="text/css"/>
