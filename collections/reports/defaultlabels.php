	...
	<html lang="<?php echo $DEFAULT_LANG; ?>">
		<head>
			...
			<style type="text/css">
				...
				if($rowsPerPage !== 1){
					?>
					table.labels td:first-child {padding:10px 23px 10px 0;}
					table.labels td:not(:first-child):not(:last-child) {padding:10px 23px 10px 23px;}
					table.labels td:last-child {padding:10px 0 10px 23px;}
					<?php
				}
				?>
                        ...
                        if($barcodeOnly){
                            ...
                            for($i = 0;$i < $dupCnt;$i++){
                                ...
                                <td style="vertical-align: top;">
                                    ...
                                    if($hMid !== 4) {
                                        echo '<div class="family">' . $occArr['family'] . '</div>';
                                    }
                                    ?>
                                    ...
                                    if($occArr['decimallatitude'] || $occArr['verbatimcoordinates']){
                                        ...
                                        <div class="loc2div">
                                            ...
                                            if($occArr['coordinateuncertaintyinmeters']) {
                                                echo '<span style="margin-left:10px;">+-' . $occArr['coordinateuncertaintyinmeters'] . ' meters</span>';
                                            }
                                            if($occArr['geodeticdatum']) {
                                                echo '<span style="margin-left:10px;">[' . $occArr['geodeticdatum'] . ']</span>';
                                            }
                                            ?>
                                        </div>
                                        <?php
