...
<div id="mainContainer" style="padding: 10px 15px 15px;">
    <div id="breadcrumbs">
        ...
        elseif($collid){
            echo '<a href="../misc/collprofiles.php?collid='.$collid.'" tabindex="1">Collection Management Panel</a> &gt;&gt; ';
        }
        ?>
        <a href="labelmanager.php?collid=<?php echo $collid; ?>" tabindex="1">Print Labels/Annotations</a> &gt;&gt;
