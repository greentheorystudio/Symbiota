...
<head>
    ...
    <meta name="description" content="Collection loan management for the <?php echo $GLOBALS['DEFAULT_TITLE']; ?> portal">
	...
	<script src="<?php echo $GLOBALS['CLIENT_ROOT']; ?>/js/collections.loans.js?ver=<?php echo $GLOBALS['JS_VERSION']; ?>" type="text/javascript"></script>
</head>
<body>
	<?php
    ...
    <div id="mainContainer" style="padding: 10px 15px 15px;">
        <div id="breadcrumbs">
            ...
            <a href='index.php?collid=<?php echo $collId; ?>' tabindex="1"> <b>Loan Management</b></a>
        </div>
        <?php
