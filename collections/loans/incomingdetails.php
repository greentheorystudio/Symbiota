		...
		<form name="editloanform" action="index.php" method="post">
			<fieldset>
				...
				<div style="margin-left:20px;padding-top:4px;float:left;">
					...
					<span>
						<input type="text" autocomplete="off" name="createdbyborr" tabindex="96" maxlength="32" style="width:100px;" value="<?php echo ($loanArr['createdbyborr']?:$GLOBALS['PARAMS_ARR']['un']); ?>" onchange=" " disabled />
					</span>
				</div>
				<div style="margin-left:20px;padding-top:4px;float:left;">
					<span>
						...
						<span>
							<select name="iidowner" style="width:400px;" >
								...
								foreach($instArr as $k => $v){
									echo '<option value="'.$k.'" '.((int)$loanArr['iidowner'] === (int)$k?'SELECTED':'').'>'.$v.'</option>';
								}
								?>
							</select>
						</span>
