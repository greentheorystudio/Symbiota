...
<head>
    ...
    <script src="../js/symb/collections.search.js?ver=2" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        ...
        function changeTablePage(index){
            ...
            const params = 'starr='+JSON.stringify(stArr)+'&targettid=<?php echo $targetTid; ?>&queryId=<?php echo $queryId; ?>&occindex='+index+'&sortfield1='+sortfield1+'&sortfield2='+sortfield2+'&sortorder='+sortorder;
