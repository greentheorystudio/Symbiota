...
if($SYMB_UID){
    ...
    if(!$collEditor){
        echo '<div>Personal occurrence management or collection management has not been setup for your login. Please contact the site administrator (<a href="mailto:'.$ADMIN_EMAIL.'">'.$ADMIN_EMAIL.'</a>) to activate this feature.</div>';
    }
}
?>	
</div>
