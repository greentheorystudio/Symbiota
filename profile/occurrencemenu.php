...
foreach($collArr as $id => $collectionArr){
    if($collectionArr['colltype'] === 'General Observations') {
        $genArr[$id] = $collectionArr;
    }
    elseif($collectionArr['colltype'] === 'Preserved Specimens') {
        $cArr[$id] = $collectionArr;
    }
    elseif($collectionArr['colltype'] === 'Observations') {
        $oArr[$id] = $collectionArr;
    }
}
?>
            ...
            <fieldset>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <?php
                        if($commCnt = $specHandler->unreviewedCommentsExist($collId)) {
                            echo '- <span style="color:orange">' . $commCnt . ' unreviewed comments</span>';
                        }
                        ?>
                    </li>
                </ul>
