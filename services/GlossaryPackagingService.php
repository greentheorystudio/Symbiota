...
class GlossaryPackagingService {
    ...
    public function processDocxDownload($glossidArr, $options, $filename): void
    {
        ...
        if($glossidArr && $options && $filename && $targetPath){
            ...
            $translationArr = $options['downloadFormat'] === 'translation' ? (new Glossary)->getGlossaryRelatedTermsDataFromGlossidArr($glossidArr, 'translation', $options['translationLanguageArr']) : array();
