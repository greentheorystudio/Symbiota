...
class SearchService {
    ...
    public function getSearchMofData($fromStr, $whereStr): array
    {
        ...
        if($fromStr && $whereStr){
            ...
            $sql .= 'eventid IN(SELECT o.eventid ' . $fromStr . $whereStr . ') OR ';
            $sql .= 'occid IN(SELECT o.occid ' . $fromStr . $whereStr . ') ';
    ...
    public function prepareOccurrenceCatalogNumberWhereSql($searchTermsArr): string
    {
        ...
        if(count($tempArr) > 0){
            $returnVal = 'o.occid IN(SELECT occid FROM (' . implode(' UNION ALL ', $tempArr) . ') AS combinedCatalogNumber)';
        }
        return $returnVal;
    }
    ...
    public function prepareOccurrenceCollectionNumberWhereSql($searchTermsArr): string
    {
        ...
        if(count($tempArr) > 0){
            $returnVal = 'o.occid IN(SELECT occid FROM (' . implode(' UNION ALL ', $tempArr) . ') AS combinedCollectionNumber)';
        }
        return $returnVal;
    }
    ...
    public function prepareOccurrenceCollectorWhereSql($searchTermsArr): string
    {
        ...
        if(count($tempArr) > 0){
            $returnVal = 'o.occid IN(SELECT occid FROM (' . implode(' UNION ALL ', $tempArr) . ') AS combinedCollector)';
        }
        return $returnVal;
    }
    ...
    public function prepareOccurrenceCountryWhereSql($searchTermsArr): string
    {
        ...
        if(count($tempArr) > 0){
            $returnVal = 'o.occid IN(SELECT occid FROM (' . implode(' UNION ALL ', $tempArr) . ') AS combinedCountry)';
        }
        return $returnVal;
    }
    ...
    public function prepareOccurrenceCountyWhereSql($searchTermsArr): string
    {
        ...
        if(count($tempArr) > 0){
            $returnVal = 'o.occid IN(SELECT occid FROM (' . implode(' UNION ALL ', $tempArr) . ') AS combinedCounty)';
        }
        return $returnVal;
    }
    ...
    public function prepareOccurrenceLocalityWhereSql($searchTermsArr): string
    {
        ...
        if(count($tempArr) > 0){
            $returnVal = 'o.occid IN(SELECT occid FROM (' . implode(' UNION ALL ', $tempArr) . ') AS combinedLocality)';
        }
        return $returnVal;
    }
    ...
    public function prepareOccurrenceOccurrenceRemarksWhereSql($searchTermsArr): string
    {
        ...
        if(count($tempArr) > 0){
            $returnVal = 'o.occid IN(SELECT occid FROM (' . implode(' UNION ALL ', $tempArr) . ') AS combinedOccurrenceRemarks)';
        }
        return $returnVal;
    }
    ...
    public function prepareOccurrenceSpatialWhereSql($searchTermsArr): string
    {
        ...
        if(count($tempArr) > 0){
            $returnVal = 'o.occid IN(SELECT occid FROM (' . implode(' UNION ALL ', $tempArr) . ') AS combinedSpatial)';
        }
        return $returnVal;
    }
    ...
    public function prepareOccurrenceStateProvinceWhereSql($searchTermsArr): string
    {
        ...
        if(count($tempArr) > 0){
            $returnVal = 'o.occid IN(SELECT occid FROM (' . implode(' UNION ALL ', $tempArr) . ') AS combinedStateProvince)';
        }
        return $returnVal;
    }
