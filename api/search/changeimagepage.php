...
if(SanitizerService::validateInternalRequest()){
    ...
    if($collManager->validateSearchTermsArr($stArr)){
        if(strlen($stArrJson) <= 1800){
            $urlPrefix = SanitizerService::getFullUrlPathPrefix().'/media/search.php';
        ...
        $recordListHtml .= '<div><a href="../collections/occurrenceNavigator.php?interface=list&queryId='.$queryId.'"><button class="icon-button" title="List Display"><i style="height:15px;width:15px;" class="fas fa-list"></i></button></a></div>';
        $recordListHtml .= '<div><a href="../collections/occurrenceNavigator.php?interface=table&queryId='.$queryId.'"><button class="icon-button" title="Table Display"><i style="width:15px;height:15px;" class="fas fa-table"></i></button></a></div>';
        $recordListHtml .= '<div><a href="../collections/occurrenceNavigator.php?interface=spatial&queryId='.$queryId.'"><button class="icon-button" title="Spatial Module"><i style="width:15px;height:15px;" class="fas fa-globe"></i></button></a></div>';
        if(strlen($stArrJson) <= 1800){
