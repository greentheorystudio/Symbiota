...
function openFirstRecSet(){
	...
	if (selObj.selectedIndex > -1) {
		...
		occWindow = open("../occurrenceNavigator.php?interface=occurrence&collid=" + collId + "&q_catalognumber=occid" + occidStr, "occsearch", "resizable=1,scrollbars=1,toolbar=1,width=950,height=700,left=20,top=20");
