...
function getVineWorkingSpinnerHtml(size = null){
	return '<svg class="nativeVineWorkingspinner"' + (size ? ' style="width:'+size+'px;height:'+size+'px;"' : '') + ' viewBox="0 0 100 100">' +
		'    <clipPath id="vinePath">' +
