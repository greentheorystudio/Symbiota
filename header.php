        ...
        <div class="uw-header-container">
            <div class="uw-header-crest-title">
                <div class="uw-header-crest">
                    <a href="https://herbarium.wisc.edu/" aria-hidden="true" tabindex="-1"><svg viewBox="0 0 55.5 87.28" version="1.1" role="img" focusable="false" aria-hidden="true" aria-labelledby="dynid618454355f7519.98211154">
                            <title id="dynid618454355f7519.98211154">UW Crest</title>
                            <style>
                    ...
                    <h1 id="site-title" class="uw-site-title uw-red-title ">
                        <a href="https://herbarium.wisc.edu/" rel="home">Wisconsin State Herbarium</a>
                    </h1>


                    <div id="site-description" class="uw-site-tagline">Department of Botany</div>
                </div>
            </div>
        </div>
    </header>
