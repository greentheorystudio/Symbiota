...
<div id="mainContainer">
    <div id="bannerContainer">
        <span>
            <img style="margin:0;" src="<?php echo $GLOBALS['CLIENT_ROOT']; ?>/content/imglib/layout/Picture1.png" />
        </span>
        <span>
            <img style="margin:0;" src="<?php echo $GLOBALS['CLIENT_ROOT']; ?>/content/imglib/layout/title.png" />
        </span>
    </div>
