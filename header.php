...
<div id="appContainer">
    <div id="bannerContainer">
        <div>
            <img src="<?php echo $GLOBALS['CLIENT_ROOT']; ?>/content/imglib/layout/seedtrack-logo.png" />
        </div>
        <div class="banner-image-container">
            <div class="banner-image-box">
                <img class="banner-image" src="<?php echo $GLOBALS['CLIENT_ROOT']; ?>/content/imglib/layout/IMG_6681.JPG" />
            </div>
            <div class="banner-image-box">
                <img class="banner-image" src="<?php echo $GLOBALS['CLIENT_ROOT']; ?>/content/imglib/layout/IMG_6580.JPG" />
            </div>
            <div class="banner-image-box">
                <img class="banner-image" src="<?php echo $GLOBALS['CLIENT_ROOT']; ?>/content/imglib/layout/IMG_6672.jpg" />
            </div>
            <div class="banner-image-box">
                <img class="banner-image" src="<?php echo $GLOBALS['CLIENT_ROOT']; ?>/content/imglib/layout/IMG_6826.JPG" />
            </div>
        </div>
    </div>
