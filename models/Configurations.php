...
class Configurations{
    ...
    public function deleteMapDataFile($fileName): int
    {
        $fullPath = $GLOBALS['SERVER_ROOT'] . '/content/spatial/' . $fileName;
    ...
    public function setGlobalArr(): void
    {
        ...
        $GLOBALS['CSS_VERSION'] = '20260204';
        $GLOBALS['JS_VERSION'] = '202602091111111111111111111111222222222';
    ...
    public function validateGlobalArr(): void
    {
        ...
        $GLOBALS['GBIF_CREDENTIALS_CONFIGURED'] = (
