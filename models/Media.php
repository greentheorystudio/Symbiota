...
class Media{
    ...
    public function clearExistingMediaNotInUpload($collid, $clearDerivatives): int
    {
        ...
        $sql = 'SELECT m.mediaid FROM media AS m LEFT JOIN omoccurrences AS o ON m.occid = o.occid '.
            'LEFT JOIN uploadmediatemp AS m1 ON o.occid = m1.occid AND m.accessuri = m1.accessuri '.
            'LEFT JOIN uploadmediatemp AS m2 ON o.occid = m2.occid AND m.sourceurl = m2.accessuri '.
