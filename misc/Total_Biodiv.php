        ...
        <div id="intro-section" class="cd-section">
            ...
            <div style="margin: 15px 0;display:flex;justify-content: center;">
                <figure style="margin: 15px;">
                    <img style="border:0;width:375px;" src="<?php echo $GLOBALS['CLIENT_ROOT']; ?>/content/imglib/static/old_IRL_bidiversity_pie_chart.jpg" alt="Pie chart showing biological kingdoms: Animalia 71.4%, Protista 17.0%, Plantae 11.6%." />
                </figure>
            </div>
            <p>
