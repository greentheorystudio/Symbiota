                ...
                <tr>
                    <td><p class="body">Oyster reefs, often referred to as oyster bars, are common
                        ...
                        <table class="image_left">
                            <tr>
                                <td><img border="5" src="../content/imglib/Crasso_virgin2.jpg" align="left" style="margin: 5px" width="228" height="218"></td>
                            </tr>
                        </table>
                        ...
                        <p class="body">Oyster reefs also contribute to improved water quality
                            ...
                            immense. Additionally, since oysters are <a href="#sessile" onClick="popDef('non-motile;  living permanently attached to a substratum', '#sessile');" name="sessile">sessile</a>, and bioaccumulate some
                        ...
                        <p class="body"><i>A more detailed look at some emerging human-induced threats facing the oyster reefs of the IRL is <a href="Oystereef_Emerging_Issues.php">available here</a></i></p>
                        <p class="title">Click a highlighted link to read more about individual species:</p>
                    </td>
                </tr>
            </table>

            <table style="border:0;width:700px;margin-left:auto;margin-right:auto;" cellpadding="2" class="table-border no-border alternate">
                <tr>
                    <th>Species Name</th>
                    <th>Common name</th>
                    <th>Comments</th>
                ...
                <tr>
                    <td><span><i><a href="../taxa/index.php?taxon=Argopecten irradians concentricus">Argopecten irradians concentricus</a></i></span></td>
                ...
                <tr>
                    <td><span><i><a href="../taxa/index.php?taxon=Eurypanopeus depressus">Eurypanopeus depressus</a></i></span></td>
                ...
                <tr>
                    <td><span><i><a href="../taxa/index.php?taxon=Pinnotheres maculatus">Pinnotheres maculatus</a></i></span></td>
                ...
                <tr>
                    <td><span><i><a href="../taxa/index.php?taxon=Eucinostomus argentus">Eucinostomus argentus</a></i></span></td>
                ...
                <tr>
                    <td>
                        ...
                        <p class="body">Burrell, V.G. 1986. Species Profiles: Life
                            ...
                            American Oyster. U.S. Fish and Wildlife Service. Biological Report 82(11.57). <br />&nbsp;&nbsp; U.S. Army Corps of Engineers. TR EL-82-4. 17 pp.</p>
                        <p class="body">Kumari, Siva, and C. Solis. 1995. The State of
                            the Bay: a Characterization of the Galveston Bay Ecosystem. Rice university, Houston, TX. Accessed on-line at: <a HREF="http://galvbaydata.org/StateoftheBay/tabid/1846/Default.aspx">www.rice.edu/armadillo/Galveston/Chap3/oyster.html</a>.</p>
                        <p class="body">Livingston, Robert J. 1990. Inshore Marine Habitats. In: Ecosystems of Florida, Ronald L. Myers and John J. <br />&nbsp;&nbsp; Ewel, Eds. University of Central Florida Press, Orlando, FL. Pp. 549-573.</p>
                        <p class="body">Lunz, G.R., Jr. 1960. Intertidal Oysters. Wards
                            Natl. Sci. Bull. 34(1): 3-7</p>
                        <p class="body">Wells, H.W. 1961. The Fauna of Oyster Beds with Special Reference to the Salinity Factor. Ecological <br />&nbsp;&nbsp; Monographs 31(3): 239-266.</p>
                    </td>
                </tr>
                <tr>
                    <td>
