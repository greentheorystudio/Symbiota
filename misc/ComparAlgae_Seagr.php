	...
	<body>
		...
		<div id="innertext">
            <table cellpadding="0" cellspacing="0" style="border-collapse:collapse;border:0;border-color:#111111;width:550px;margin-left:auto;margin-right:auto;">
                <tr>
                    <td height="44">
                        <p align="left"><font color="#036" size="5" style="text-align:center"><b>Algae vs Seagrass</b></font><br />
                            <br />
            ...
            <table width="552" align="center">
                <tr>
                    <td><span class="medium"><b><font color="#000080">A comparison of algal morphology with seagrass morphology:</font>&nbsp;</b>&nbsp;
