            ...
            <table style="border:0;width:700px;margin-left:auto;margin-right:auto;">
                <tr>
                    <td><p class="body">Many people wonder why scientists use complicated, hard to pronounce names when speaking about familiar animals and plants. Common names such as blue crab, redfish, and dolphin are successfully used in casual communication, and convey an immediate idea of what a particular animal or plant looks like. Scientists avoid using common names because they are often not specific to a particular species. For instance, the blue crab is only one of many species of crabs that can be described as blue. In the Indian River Lagoon alone, there are several species of "blue crabs": the blue crab (Callinectes sapidus), the lesser blue crab (Callinectes similis), the red blue crab (Callinectes bocourti), the ornate blue crab (Callinectes ornatus), and the blue land crab (Cardisoma guanhumi).<br />
                        ...
                        <p class="body">Linnaeus' original classification system is based on 2 main goals. The first is to distinguish between closely related species and assign them as separate species based on differences in specific traits called diagnostic characters. The second goal of taxonomy is to organize groups of similar species into broader and more collective categories. For example, the species name for the domestic cat is Felis catus. Felis denotes the genus name for this species, while catus denotes the unique specific epithet for the species.</p>
                        ...
                        <table width="200" class="image_left">
                            <tr>
                                <td><img border="0" src="../content/imglib/CatOrder.jpg" width="276" height="142" align="left"></td>
                            </tr>
                        </table>
                        ...
                        <p class="body">At the Phylum level, cats are included with all other vertebrate animals in the subphylum Vertebrata, in the Phylum Chordata. This large grouping includes all animals having either a notochord, or an actual spine. Lastly, the most inclusive taxonomic grouping is the Kingdom. Biologists often delimit the basic taxonomic groupings used to classify all living things into a 5 kingdom scheme. Kingdom Monera includes all the bacteria and other Prokaryotic cell types; Kingdom Protista includes all the algae and single celled Eukaryotes; Kingdom Animalia includes all the animals; Kingdom Plantae includes all the plants; and Kingdom Fungi includes all of the fungi and molds.</p>
                    </td>
                </tr>
            </table>
        </div>
