...
<div id="innertext">
    ...
    <table style="border:0;width:700px;margin-left:auto;margin-right:auto;">
        <tr>
            <td>
                <table width="280" class="image_left">
                    <tr>
                        <td><img border="0" src="../content/imglib/IRLZonesMap.gif" hspace="2" vspace="2" width="271"
                                 height="140"></td>
                    </tr>
                </table>
                <p class="body">The
        ...
        <tr>
            <td width="500">
                <table class="image_left">
                    <tr>
                        <td><img src="../content/imglib/IRLMap.gif" align="right" style="margin: 5px" width="267"
                                 height="539"></td>
                    </tr>
                </table>
