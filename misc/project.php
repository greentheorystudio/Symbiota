...
<html lang="<?php echo $GLOBALS['DEFAULT_LANG']; ?>">
    ...
    <body>
        ...
        <div id="mainContainer">
            <div class="q-pa-md">
                <div style="margin:15px;display:flex;justify-content:space-between;overflow:hidden;">
                    ...
                    <div style="width:330px;">
                        <div style="width:325px;">
                            <img style="width:325px;" src="<?php echo $GLOBALS['CLIENT_ROOT']; ?>/content/imglib/layout/Pressing_Lomatium_cf._columbianum_04212020.jpg" />
                        </div>
                        <div style="width:310px;margin-top:5px;margin-left:auto;margin-right:auto;font-size:12px;">
                            Mark Darrach, Herbarium - Burke Museum, University of Washington
                        </div>
                    </div>
                </div>
                ...
                <div style="margin:15px;display:flex;justify-content:space-between;">
                    <div style="width:230px;">
                        <div style="width:225px;">
                            <img style="width:225px;" src="<?php echo $GLOBALS['CLIENT_ROOT']; ?>/content/imglib/layout/DSC02708.JPG" />
                        </div>
                    ...
                    <div style="min-width:740px;max-width:800px;padding-left:15px;">
                        <div style="margin:15px;display:flex;justify-content:space-between;overflow:hidden;">
                            ...
                            <div style="width:330px;">
                                <div style="width:325px;">
                                    <img style="width:325px;" src="<?php echo $GLOBALS['CLIENT_ROOT']; ?>/content/imglib/layout/DSC02667.JPG" />
                                </div>
                                <div style="width:310px;margin-top:5px;margin-left:auto;margin-right:auto;font-size:12px;">
                        ...
                        <div style="width:560px;margin-top:20px;margin-left:auto;margin-right:auto">
                            <div style="width:555px;">
                                <img style="width:555px;" src="<?php echo $GLOBALS['CLIENT_ROOT']; ?>/content/imglib/layout/DSC02997.JPG" />
                            </div>
        ...
        <script type="text/javascript">
            const projectPageModule = Vue.createApp();
            projectPageModule.use(Quasar, { config: {} });
            projectPageModule.use(Pinia.createPinia());
            projectPageModule.mount('#mainContainer');
        </script>
    </body>
</html>
