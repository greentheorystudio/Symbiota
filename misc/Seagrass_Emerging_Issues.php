	...
	<body>
		...
		<div id="innertext">
            ...
            <table style="border:0;width:700px;margin-left:auto;margin-right:auto;">
                <tr>
                    <td align="center"><img border="0" src="../content/imglib/seagrassissues1.jpg" width="320" height="250"></td>
                </tr>
            </table>
            <table style="border:0;width:700px;margin-left:auto;margin-right:auto;">
                <tr>
                    <td><p class="title">Introduction</p>
                        ...
                        <p class="body">The historic IRL watershed was around 231,480 ha (572,00 acres). Since
                            ...
                            detailed look at seagrass coverages trends over time in the lagoon, <a href="IRL_Seagrasstrends.htm">click
                                here</a>.</p>
                        ...
                        <p class="body">The Indian River Lagoon-South project is a large-scale freshwater
                            ...
                            reducing nutrient, pesticide, and pollutant loads. The <a href="http://141.232.10.32/pm/projects/proj_07_irl_south.aspx" target="new">Indian River
                        ...
                        <p class="body">One of the current stormwater management initiatives being implemented along the entire lagoon is the installation of large sediment traps, sometimes
                ...
                <tr>
                    <td>
                        ...
                        <p class="body">Brevard County Health Department. Undated. &quot;Eat Puffer, You Will Suffer.&quot;
                            ...
                            Conservation Commission. Undated. Red Tides In Florida. Available <a href="http://myfwc.com/research/redtide/general/about/" target="new">online</a>. <br />
                            <br />
            ...
            <table style="border:0;width:700px;margin-left:auto;margin-right:auto;">
                <tr>
                    <td><p class="footer_note">Report by: J. Masterson, Smithsonian Marine Station <br />
                            Submit additional information, photos or comments to: <a href="mailto:irl_webmaster@si.edu">irl_webmaster@si.edu </a></p></td>
                </tr>
            </table>
        </div>
		<?php
