	...
	<body>
		...
		<div id="innertext">
			...
			<ul>
				...
				<li><a href="<?php echo $GLOBALS['CLIENT_ROOT']; ?>/misc/usfspacificsouthwest.php">Pacific Southwest</a></li>
				<li><a href="">Rocky Mountain</a></li>
				<li><a href="">Southern</a></li>
				<li><a href="<?php echo $GLOBALS['CLIENT_ROOT']; ?>/misc/usfssouthwest.php">Southwest</a></li>
            </ul>
		</div>
		<?php
