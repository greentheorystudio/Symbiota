	...
	<body>
		...
		<div id="innertext">
			<div style="float:right;margin-right:20px;">
				<img src="<?php echo $CLIENT_ROOT; ?>/images/layout/US-FWS-logo.png" style="height:125px;border:0;" />
			</div>
			<h1>FWS Regions</h1>
			<ul>
				<li><a href="">Headquarters</a></li>
				<li><a href="">Region 1 - Pacific</a></li>
				<li><a href="<?php echo $CLIENT_ROOT; ?>/projects/index.php?pid=24">Region 2 - Southwest</a></li>
