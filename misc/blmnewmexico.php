	...
	<body>
		...
		<div id="innertext">
			<div style="float:right;margin-right:20px;">
				<img src="<?php echo $GLOBALS['CLIENT_ROOT']; ?>/images/layout/BLM_logo.fw.png" style="height:125px;border:;" />
			</div>
			<h1>BLM New Mexico Offices</h1>
			<ul>
				<li><a href="">Carlsbad Field Office</a></li>
				<li><a href="">Farmington Field Office</a></li>
				<li><a href="<?php echo $GLOBALS['CLIENT_ROOT']; ?>/projects/index.php?pid=103">Las Cruces District Office</a></li>
				<li><a href="">Rio Puerco Field Office</a></li>
				<li><a href="">Roswell Field Office</a></li>
				<li><a href="">Socorro Field Office</a></li>
				<li><a href="<?php echo $GLOBALS['CLIENT_ROOT']; ?>/checklists/checklist.php?cl=4004&emode=0">Taos Field Office</a></li>
			</ul>
		</div>
		<?php
