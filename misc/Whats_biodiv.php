...
<head>
    <title>Biodiversity in the Indian River Lagoon</title>
...
?>
<div id="innertext">
    <h2>Biodiversity in the Indian River Lagoon</h2>
    <table style="border:0;width:700px;margin-left:auto;margin-right:auto;">
        <tr>
            <td><p class="title">The Problem: Loss of Species</p>
                <p class="body">By the early 1980s, scientists around the world
                    ...
                    Cretaceous period 65 million years ago when many species, including the dinosaurs became extinct.
                    The crisis facing species today differs in one
                    ...
                    and conservation were brought into public focus. However, maintaining the biological diversity of
                    marine
                    ...
                    rich and have greater ecosystem diversity than terrestrial systems. Representatives from 32 of the
                    33 known animal phyla can be found in ocean and coastal waters. Of these, 15 phyla occur
                    exclusively in estuarine or marine environments.</p>

                <p class="title">Defining Biodiversity:</p>
                <p class="body">The vast wealth of life on earth is unified by a
                    ...
                    are. Healthy ecosystems support high biological diversity; while stressed or highly disturbed
                    ecosystems do not. When we
                ...
                <p class="title">Genetic Level Biodiversity:</p>

                <p class="body">The term &quot;genetic diversity&quot; is the
                    ...
                    will define a <b>species</b> as a group consisting of all the collected populations of
                    morphologically similar organisms which are able to
                    interbreed with one another. A <b>population</b> is defined as consisting
                    of all the individuals of the same species within a defined geographical area,
                    for example, the Indian River Lagoon.</p>
                <p class="body">Within a species, it is theoretically possible
                    ...
                    genetic adaptations which allow it to live optimally within a particular habitat.</p>
                <p class="body">This genetic divergence is the basis for
                    ...
                    human influenced challenges to its survival.</p>

                <p class="body">This term, quite simply, is the measure of the
                    ...
                    widely depending upon latitudinal and longitudinal location. Along a latitudinal gradient, species
                    diversity tends to increase toward tropical areas. Within tropical areas, species diversity tends to
                    increase
                    ...
                    found in the eastern Atlantic.</p>

                <p class="title">Ecosystem Diversity:</p>

                <p class="body">Ecosystems are the collection of all the plants and
                    ...
                    marshes, generally have high <a href="#primary production"
                                                    onClick="popDef('The manufacture of organic compounds produced by plants as the result of photosynthesis', '#primary production');"
                                                    Name="primary production">primary production</a>. Coral reefs, an
                    entirely
                    ...
                    not penetrate such vast depths.</p>

                <p class="title">Threats to Biodiversity:</p>

                <p class="body">The factors which threaten biodiversity in
                ...
                <p class="title">The Solution: Preserving Biodiversity:</p>
                <p class="body">In order to insure biological diversity in
                    both marine and terrestrial systems, we must finally recognize the fact that our natural resource
                    base,
                    ...
                    own continued prosperity and survival.</p>
            </td>
        </tr>
    </table>
    ...
    <table style="border:0;width:700px;margin-left:auto;margin-right:auto;">
        <tr>
            <td><p class="title">Further Reading:</p>
                <p class="body">Norse, Elliot A. 1993. Global Marine Biological
                    Diversity: A Strategy for Building Conservation Into Decision Making. Island Press, Washington, D.C.
                    384 pp.</p>
                <p class="body">Thorne-Miller, Boyce, and J. Catena. 1991. The
                    Living Ocean: Understanding and Protecting Marine Biodiversity. Island
                    press, Washington D.C.180 pp.</p>
