	...
	<body>
		...
		<div id="innertext">
            ...
            <table style="border:0;width:700px;margin-left:auto;margin-right:auto;" cellpadding="5" cellspacing="3">
                <tr>
                    <td align="center"><img border="0" src="../content/imglib/Mar_Hammock1.jpg" hspace="5" vspace="5" width="393" height="323"></td>
                </tr>
            </table>
            <br />
            ...
            <table style="border:0;width:700px;margin-left:auto;margin-right:auto;" cellpadding="7" cellspacing="1" class="table-border no-border alternate">
                <tr>
                    <th>Species Name</th>
                    <th>Common Name</th>
                ...
                <tr>
                    <td>
                        <span><i>Acer rubrum</i></span></td>
                    <td>
                        <span>Red maple</span></td>
                    <td>
              <span>Canopy, Volusia to Indian River Counties;
              maritime swamp forest, maritime shrub swamp,</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Acrostichum aureum</i></span></td>
                    <td>
                        <span>Golden leather fern</span></td>
                    <td>
              <span>Herbaceous<sup>1</sup>, maritime swamp
              foret, maritime shrub swamp</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Ampelopsis arborea</i></span></td>
                    <td>
                        <span>Peppervine</span></td>
                    <td>
              <span>Understory<sup> </sup>vine<sup>1 </sup>of
              maritime evergreen forest,</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Amyris elemifera</i></span></td>
                    <td>
                        <span>Sea torchwood</span></td>
                    <td>
              <span>Understory<sup>2</sup> of maritime shrub,
              maritime evergreen forest, maritime deciduous forest</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i><a href="../taxa/index.php?taxon=Ardisia escallonioides">Ardisia escallonioides</a></i></span></td>
                    <td>
                        <span>Marbleberry, marlberry</span></td>
                    <td>
              <span>Understory<sup>3</sup> of maritime shrub,
              maritime evergreen forest, maritime deciduous forest</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i><a href="../taxa/index.php?taxon=Aristida stricta">Aristida stricta</a></i></span></td>
                    <td>
                        <span>Bottlebrush, threeawn</span></td>
                    <td>
              <span>Herbaceous<sup>1</sup>, maritime
              evergreen forest, coastal fringe sandhill</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Arundinaria gigantea</i></span></td>
                    <td>
                        <span>Switchcane</span></td>
                    <td>
              <span>Understory Volusia County, maritime
              deciuous forest, maritime swamp forest</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Asplenium platyneuron</i></span></td>
                    <td>
                        <span>Ebony spleenwort</span></td>
                    <td>
              <span>herbaceous<sup>2</sup>, maritime
              evergreen forest, coastal fringe evergreen forest</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Azolla caroliniana</i></span></td>
                    <td>
                        <span>Carolina mosquito fern</span></td>
                    <td>
                        <span>interdune ponds<sup>1</sup></span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Baccharis halmifolia</i></span></td>
                    <td>
                        <span>Sea myrtle, groundsel tree</span></td>
                    <td>
              <span>Understory<sup>1</sup>,<sup> </sup>maritime
              shrub, maritime evergreen forest, maritime deciduous forest</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Berchemia scadens</i></span></td>
                    <td>
                        <span>Alabama supplejack, rattan vine</span></td>
                    <td>
              <span>wetland vine<sup>1</sup>, maritime
              evergreen forest, maritime swamp forest, maritime shrub swamp</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Bignonia capreolata</i></span></td>
                    <td>
                        <span>Crossvine</span></td>
                    <td>
              <span>Understory<sup> </sup>vine<sup>2</sup>,
              Volusia County, maritime evergreen forest</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Blechnum serrulatum</i></span></td>
                    <td>
                        <span>Blechnum fern, swamp fern</span></td>
                    <td>
              <span>Wet herbaceous<sup>1</sup>, maritime
              swamp forest, maritime shrub swamp</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Boehmeria cylindrica</i></span></td>
                    <td>
                        <span>False nettle, bog hemp</span></td>
                    <td>
              <span>Wet herbaceous<sup>1,</sup> maritime
              swamp forest</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Bursera simaruba</i></span></td>
                    <td>
                        <span>Gumbo-limbo</span></td>
                    <td>
              <span>Canopy<sup>3</sup>, maritime evergreen
              forest, maritime deciduous forest</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i><a href="../taxa/index.php?taxon=Callicarpa americana">Callicarpa americana</a></i></span></td>
                    <td>
                        <span>American beautyberry</span></td>
                    <td>
              <span>Understory<sup>3</sup>, maritime shrub,
              maritime evergreen forest, maritime deciduous forest</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Campsis radicans</i></span></td>
                    <td>
                        <span>Trumpet creeper</span></td>
                    <td>
              <span>Understory vine<sup>2</sup>, maritime
              evergreen forest, coastal fringe evergreen forest</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Carex spp.</i></span></td>
                    <td>
                        <span>Sedge</span></td>
                    <td>
              <span>herbaceous<sup>2</sup>, maritime swamp
              forest</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Carpinus caroliniana</i></span></td>
                    <td>
                        <span>Bluebeech, American hornbeam</span></td>
                    <td>
              <span>Understory<sup>2</sup>, maritime
              evergreen forest, maritime deciduous forest</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Carya glabra</i></span></td>
                    <td>
                        <span>Pignut hickory</span></td>
                    <td>
              <span>Canopy<sup>2</sup>, maritime deciduous
              forest, coastal fringe evergreen forest</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Ceratophyllum muricatum australe</i></span></td>
                    <td>
                        <span>Prickly hornwart</span></td>
                    <td>
                        <span>Interdune pond, Brevard county</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Chasmanthium laxum</i></span></td>
                    <td>
                        <span>Slender woodoats</span></td>
                    <td>
              <span>Herbaceous<sup>2</sup>, maritime
              evergreen forest</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i><a href="../taxa/index.php?taxon=Chiococca alba">Chiococca alba</a></i></span></td>
                    <td>
                        <span>Snowberry</span></td>
                    <td>
              <span>Understory vine<sup>3</sup>, maritime
              shrub, maritime evergreen forest, maritime deciduous forest,
              maritime swamp forest, maritime shrub swamp</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Cnidoscolus stimulosus</i></span></td>
                    <td>
                        <span>Finger rot</span></td>
                    <td>
              <span>Understory<sup>3</sup>, maritime
              deciduous forest, coastal fringe sandhill</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Coccoloba diversifolia</i></span></td>
                    <td>
                        <span>Pigeon plum, tie tongue</span></td>
                    <td>
              <span>Canopy<sup>3</sup>, maritime shrub,
              maritime evergreen forest, maritime deciduous forest</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i><a href="../taxa/index.php?taxon=Coccoloba uvifera">Coccoloba uvifera</a></i></span></td>
                    <td>
                        <span>Sea grape</span></td>
                    <td>
              <span>Canopy<sup>1</sup>, maritime shrub,
              maritime evergreen forest, maritime deciduous forest</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Cornus foemina</i></span></td>
                    <td>
                        <span>Swamp dogwood</span></td>
                    <td>
              <span>Understory<sup>2</sup>, maritime swamp
              forest, maritime shrub swamp</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Dahlbergia ecastophyllum</i></span></td>
                    <td>
                        <span>Coinvine</span></td>
                    <td>
              <span>Understory vine<sup>3</sup>, maritime
              shrub, maritime evergreen forest, maritime swamp forest</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Dichanthelium commutatum</i></span></td>
                    <td>
                        <span>Variable witchgrass</span></td>
                    <td>
              <span>Herbaceous<sup>1</sup>, maritime
              evergreen forest</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i><a href="../taxa/index.php?taxon=Erythrina herbacea">Erythrina herbacea</a></i></span></td>
                    <td>
                        <span>Eastern coralbean, Redcardinal</span></td>
                    <td>
              <span>Understory<sup>3</sup>, maritime shrub,
              maritime evergreen forest, coastal fringe sandhill</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Eugenia foetida</i></span></td>
                    <td>
                        <span>Spanish stopper</span></td>
                    <td>
              <span>Canopy<sup>3</sup>, maritime shrub,
              maritime evergreen forest, maritime deciduous forest</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Euphorbia ipecacuanhae</i></span></td>
                    <td>
                        <span>American euphorbia</span></td>
                    <td>
              <span>Herbaceous, coastal fringe sandhill,
              wetlands</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Exothea paniculata</i></span></td>
                    <td>
                        <span>Inkwood</span></td>
                    <td>
              <span>Canopy<sup>3</sup>, maritime shrub,
              maritime evergreen forest</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Ficus aurea</i></span></td>
                    <td>
                        <span>Strangler fig</span></td>
                    <td>
              <span>Canopy<sup>3</sup>, maritime evergreen
              forest, maritime deciduous forest</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Galium hispidulum</i></span></td>
                    <td>
                        <span>Coastal bedstraw</span></td>
                    <td>
              <span>Understory<sup>2</sup>, maritime
              deciduous forest</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Galium pilosum</i></span></td>
                    <td>
                        <span>Hairy bedstraw</span></td>
                    <td>
              <span>Herbaceous<sup>2 </sup>Volusia County,
              maritime evergreen forest</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Gaylussacia dumosa</i></span></td>
                    <td>
                        <span>Dwarf huckleberry</span></td>
                    <td>
              <span>Understory<sup>1</sup>, coastal fringe
              sandhill</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Gaylussacia frondosa</i></span></td>
                    <td>
                        <span>Blue huckleberry</span></td>
                    <td>
              <span>Understory Volusia County, maritime
              deciduous forest</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Gelsemium sempervirens</i></span></td>
                    <td>
                        <span>Yellow jessamine, Carolina jessamine</span></td>
                    <td>
              <span>Understory<sup> </sup>vine<sup>2</sup>,
              maritime evergreen forest, maritime deciduous forest, coastal
              fringe evergreen forest</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Ilex glabra</i></span></td>
                    <td>
                        <span>Inkberry, Gallberry</span></td>
                    <td>
              <span>Understory<sup>1</sup>, coastal fringe
              sandhill</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Ilex opaca</i></span></td>
                    <td>
                        <span>American Holly</span></td>
                    <td>
              <span>Understory<sup>2</sup>, maritime
              ...
              evergreen forest</span></td>
                ...
                <tr>
                    <td>
                        <span><i>Ilex vomitoria</i></span></td>
                    <td>
                        <span>Yaupon</span></td>
                    <td>
              <span>Understory<sup>2</sup>, maritime shrub,
              maritime evergreen forest, coastal fringe evergreen forest,
              coastal fringe sandhill</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Juniperus virginiana</i></span></td>
                    <td>
                        <span>Eastern redcedar</span></td>
                    <td>
              <span>Understory<sup>2</sup>, maritime shrub,
              maritime evergreen forest, maritime deciduous forest, coastal
              fringe evergreen forest</span></td>
                ...
                <tr>
                    <td>
                        <span><i>Liquidambar styraciflua</i></span></td>
                    <td>
                        <span>Sweetgum</span></td>
                    <td>
              <span>Canopy<sup>2</sup>, maritime deciduous
              forest, maritime swamp forest</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Magnolia virginiana</i></span></td>
                    <td>
                        <span>Sweetbay</span></td>
                    <td>
              <span>Understory<sup>1</sup>, coastal fringe
              evergreen forest, maritime swamp forest</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Metopium toxiferum</i></span></td>
                    <td>
                        <span>Poisonwood</span></td>
                    <td>
              <span>Canopy Martin County, maritime shrub,
              maritime evergreen forest, maritime deciduous forest</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Mitchella repens</i></span></td>
                    <td>
                        <span>Twinberry, partridgeberry</span></td>
                    <td>
              <span>Herbaceous, Volusia and Martin Counties,
              maritime evergreen forest, maritime deciduous forest, coastal
              fringe evergreen forest, maritime swamp forest</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Morus ruba</i></span></td>
                    <td>
                        <span>Red mulberry</span></td>
                    <td>
              <span>Canopy<sup>1</sup>, maritime evergreen
              forest, maritime deciduous forest, maritime swamp forest</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Myrcianthus fragrans</i></span></td>
                    <td>
                        <span>West Indian nakedwood</span></td>
                    <td>
              <span>Understory<sup>4</sup>, threatened
              species,</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i><a href="../taxa/index.php?taxon=Myrica cerifera">Myrica cerifera</a></i></span></td>
                    <td>
                        <span>Wax myrtle</span></td>
                    <td>
              <span>Understory<sup>3 </sup>of maritime shrub,
              maritime evergreen forest, maritime deciduous forest, coastal
              fringe evergreen forest, coastal fringe sandhill, swamp forest,</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Nephrolepis biserrata</i></span></td>
                    <td>
                        <span>Sword fern</span></td>
                    <td>
              <span>Herbaceous Martin County, threatened,
              maritime swamp forest, maritime shrub swamp</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Nephrolepis exaltata</i></span></td>
                    <td>
                        <span>Boston fern</span></td>
                    <td>
              <span>Herbaceous<sup>3</sup>, maritime swamp
              forest, maritime shrub swamp, coastal fringe sandhill</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Nyssa sylvatica</i></span></td>
                    <td>
                        <span>Swamp tupelo</span></td>
                    <td>
              <span>Canopy, Volusia and St. Lucie Counties,
              coastal fringe sandhill, maritime swamp forest</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Octoea (Nectandra) coriaceae</i></span></td>
                    <td>
                        <span>Lancewood</span></td>
                    <td>
              <span>Canopy<sup>1</sup>, maritime shrub,
              maritime evergreen forest, maritime deciduous forest</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Osmanthus americanus</i></span></td>
                    <td>
                        <span>Wild olive</span></td>
                    <td>
              <span>understory<sup>2</sup>, maritime
              evergreen forest, coastal fringe sandhill</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Osmunda cinnamomea</i></span></td>
                    <td>
                        <span>Cinnamon fern</span></td>
                    <td>
              <span>Herbaceous<sup>1</sup>, maritime swamp
              forest, maritime shrub swamp</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Osmunda regalis</i></span></td>
                    <td>
                        <span>Royal fern</span></td>
                    <td>
              <span>Herbaceous<sup>1</sup>, maritime swamp
              forest, maritime shrub swamp</span></td>
                </tr>
                <tr>
                    <td>
              <span><i><a href="../taxa/index.php?taxon=Palafoxia feayi">Palafoxia
              feayi</a></i></span></td>
                    <td>
                        <span>Feay's palafox</span></td>
                    <td>
              <span>Herbaceous<sup>1</sup>, maritime swamp
              forest, maritime shrub swamp</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Parthenocissus quinquefolia</i></span></td>
                    <td>
                        <span>Virginia creeper</span></td>
                    <td>
              <span>Understory vine<sup>3</sup>, maritime
              shrub, maritime evergreen forest, maritime deciduous forest</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Persea borbonia</i></span></td>
                    <td>
                        <span>Redbay</span></td>
                    <td>
              <span>Canopy<sup>1</sup>, maritime evergreen
              forest, coastal fringe evergreen forest, maritime swamp forest</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Physalis spp.</i></span></td>
                    <td>
                        <span>Ground cherry</span></td>
                    <td>
              <span>Understory<sup>3</sup>, maritime shrub,
              maritime evergreen forest, maritime deciduous forest</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Pisonia aculeata</i></span></td>
                    <td>
                        <span>Devil's claw</span></td>
                    <td>
              <span>Understory vine<sup>3</sup> Martin
              County, maritime shrub, maritime evergreen forest, maritime
              deciduous forest</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Prunus caroliniana</i></span></td>
                    <td>
                        <span>Carolina laurelcherry</span></td>
                    <td>
              <span>Understory<sup>1</sup>, maritime
              evergreen forest</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i><a href="../taxa/index.php?taxon=Psychotria nervosa">Psychotria nervosa</a></i></span></td>
                    <td>
                        <span>Shiny-leaved wild coffee</span></td>
                    <td>
              <span>Understory<sup>3</sup>, maritime shrub,
              maritime evergreen forest, maritime deciduous forest</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Psychotria sulzneri</i></span></td>
                    <td>
                        <span>Soft-leaved wild coffee</span></td>
                    <td>
              <span>Understory<sup>3</sup>, maritime shrub,
              maritime evergreen forest, maritime deciduous forest</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Pteridium aquilinum</i></span></td>
                    <td>
                        <span>Bracken fern</span></td>
                    <td>
              <span>Herbaceous<sup>1</sup>, maritime
              deciduous forest</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Quercus geminata</i></span></td>
                    <td>
                        <span>Sand live oak</span></td>
                    <td>
              <span>Canopy<sup>1</sup>, maritime evergreen
              forest, coastal fringe forest, coastal fringe sandhill</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Quercus incana</i></span></td>
                    <td>
                        <span>Bluejack oak</span></td>
                    <td>
              <span>Understory, Brevard County, maritime
              evergreen forest, coastal fringe sandhill</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Quercus laevis</i></span></td>
                    <td>
                        <span>Turkey oak</span></td>
                    <td>
              <span>Canopy, Brevard and Martin Counties,
              maritime evergreen forest, coastal fringe sandhill</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Quercus laurifolia</i></span></td>
                    <td>
                        <span>Laurel oak</span></td>
                    <td>
              <span>Canopy<sup>1</sup>, maritime evergreen
              forest, coastal fringe evergreen forest, coastal fringe sandhill</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Quercus myrtifolia</i></span></td>
                    <td>
                        <span>Myrtle oak</span></td>
                    <td>
              <span>Canopy<sup>2</sup>, maritime evergreen
              forest, maritime deciduous forest, coastal fringe evergreen forest</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Quercus nigra</i></span></td>
                    <td>
                        <span>Water oak</span></td>
                    <td>
              <span>Canopy, Volusia and Indian River
              Counties, maritime evergreen forest, maritime deciduous forest,
              coastal fringe evergreen forest,</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i><a href="../taxa/index.php?taxon=Quercus virginiana">Quercus virginiana</a></i></span></td>
                    <td>
                        <span>Live oak</span></td>
                    <td>
              <span>Canopy<sup>4</sup>, maritime evergreen
              forest, maritime deciduous forest, coastal fringe evergreen
              forest, coastal fringe sandhill,</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Randia aculeata</i></span></td>
                    <td>
                        <span>White indigoberry</span></td>
                    <td>
              <span>Understory<sup>1</sup>, maritime
              evergreen forest, maritime deciduous forest, coastal fringe
              evergreen forest, maritime swamp forest</span></td>
                ...
                <tr>
                    <td>
                        <span><i>Rhus copallina</i></span></td>
                    <td>
                        <span>Shining sumac, dwarf sumac</span></td>
                    <td>
              <span>Understory<sup>3</sup>, maritime
              deciduous forest</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Rhus copallinum</i></span></td>
                    <td>
                        <span>Winged sumac</span></td>
                    <td>
              <span>Understory<sup>1</sup>, maritime
              deciduous forest,</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Rhynchospora spp.</i></span></td>
                    <td>
                        <span>Beaksedge</span></td>
                    <td>
              <span>Herbaceous<sup>1</sup>, coastal fringe
              sandhill</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Rivina humilis</i></span></td>
                    <td>
                        <span>Rougeplant, bloodberry</span></td>
                    <td>
              <span>Understory<sup>3</sup>, maritime
              evergreen forest, maritime deciduous forest</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Rumex hastatulus</i></span></td>
                    <td>
                        <span>Sorrell</span></td>
                    <td>
              <span>Herbaceous<sup>3</sup>, maritime forest,
              maritime swamp forest, maritime shrub swamp</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Sabal minor</i></span></td>
                    <td>
                        <span>Dwarf palmetto</span></td>
                    <td>
              <span>Understory, Volusia and St. Lucie
              Counties, maritime evergreen forest, coastal fringe evergreen
              forest</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i><a href="../taxa/index.php?taxon=Sabal palmetto">Sabal palmetto</a></i></span></td>
                    <td>
                        <span>Cabbage palm</span></td>
                    <td>
              <span>Canopy<sup>1</sup>, maritime evergreen
              forest, maritime deciduous forest, coastal fringe evergreen
              forest, coastal fringe sandhill</span></td>
                ...
                <tr>
                    <td>
                        <span><i>Sassafras albidum</i></span></td>
                    <td>
                        <span>Sassafras</span></td>
                    <td>
              <span>Understory, Volusia County, maritime
              ...
              sandhill</span></td>
                ...
                <tr>
                    <td>
                        <span><i>Saururus cernuus</i></span></td>
                    <td>
                        <span>Lizard's Tail</span></td>
                    <td>
              <span>Herbaceous<sup>1</sup>, maritime swamp
              forest</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Schizachyrium (Andropogon) scoparium</i></span></td>
                    <td>
                        <span>Little bluestem</span></td>
                    <td>
              <span>Understory<sup>2</sup>, maritime
              deciduous forest</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i><a href="../taxa/index.php?taxon=Serenoa repens">Serenoa repens</a></i></span></td>
                    <td>
                        <span>Saw palmetto</span></td>
                    <td>
              <span>Understory<sup>1</sup>, maritime shrub,
              maritime evergreen forest, maritime deciduous forest, coastal
              fringe sandhill</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Sideroxylon tenax</i></span></td>
                    <td>
                        <span>Tough bumelia, tough bully</span></td>
                    <td>
              <span>Canopy<sup>2 </sup>or understory<sup>3</sup>,
              maritime shrub, maritime evergreen forest, maritime deciduous
              forest, coastal fringe sandhill</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Sideroxylon foetidissimum</i></span></td>
                    <td>
                        <span>False mastic</span></td>
                    <td>
              <span>Canopy, maritime shrub, maritime
              evergreen forest, maritime deciduous forest</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Smilax spp.</i></span></td>
                    <td>
                        <span>Greenbriar</span></td>
                    <td>
              <span>Understory<sup>1</sup>, maritime shrub,
              maritime evergreen forest, maritime deciduous forest, coastal
              fringe evergreen forest, maritime shrub swamp</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Solidago spp.</i></span></td>
                    <td>
                        <span>Goldenrod</span></td>
                    <td>
              <span>Herbaceous<sup>2</sup>, maritime
              deciduous forest</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Stipulicida setacea</i></span></td>
                    <td>
                        <span>Pineland scalypink</span></td>
                    <td>
              <span>Herbaceous<sup>1</sup>, coastal fringe
              evergreen forest, coastal fringe sandhill</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Stylisma patens</i></span></td>
                    <td>
                        <span>Coastalplain dawnflower</span></td>
                    <td>
              <span>Herbaceous<sup>1</sup>, Volusia County,
              coastal fringe sandhill</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Swietenia mahogani</i></span></td>
                    <td>
                        <span>Mahogany</span></td>
                    <td>
              <span>Hardwood canopy<sup>3</sup>, rare in IRL,
              Maritime evergreen forest, maritime deciduous forest</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Taxodium distichum</i></span></td>
                    <td>
                        <span>Bald cypress</span></td>
                    <td>
              <span>Wetland canopy<sup>1</sup>, maritime
              swamp forest</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Thelypteris palustris var. pubescens</i></span></td>
                    <td>
                        <span>Marsh fern</span></td>
                    <td>
              <span>Herbaceous<sup>1</sup>, maritime shrub
              swamp, interdune ponds</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Toxicodendron radicans</i></span></td>
                    <td>
                        <span>Eastern poison ivy</span></td>
                    <td>
              <span>Understory<sup> </sup>vine<sup>1</sup>,
              maritme shrub, maritime evergreen forest, maritime deciduous
              forest, maritime swamp forest, maritime shrub swamp</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Vaccinium arboreum</i></span></td>
                    <td>
                        <span>Sparkleberry, farkleberry</span></td>
                    <td>
              <span>Understory<sup>2</sup>, maritime
              deciduous forest, coastal fringe sandhill</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Vaccinium corymbosum</i></span></td>
                    <td>
                        <span>Highbush blueberry</span></td>
                    <td>
              <span>Wet understory, Volusia County, maritime
              swamp forest</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Vaccinium fuscatum</i></span></td>
                    <td>
                        <span>Highbush blueberry</span></td>
                    <td>
              <span>Wet understory Volusia County, maritime
              swamp forest</span></td>
                ...
                <tr>
                    <td>
                        <span><i>Vaccinium stamineum</i></span></td>
                    <td>
                        <span>Deerberry</span></td>
                    <td>
              <span>Understory<sup>1</sup>, maritime
              deciduous forest, coastal fringe sandhill, maritime swamp forest</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Vitis rotundifolia</i></span></td>
                    <td>
                        <span>Muscadine grape</span></td>
                    <td>
              <span>Understory vine<sup>1</sup>, maritime
              shrub, maritime evergreen forest, coastal fringe evergreen,
              maritime swamp forest</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Woodwardia areolata</i></span></td>
                    <td>
                        <span>Netted chain fern</span></td>
                    <td>
              <span>Wet herbaceous<sup>1</sup>, maritime
              swamp forest, maritime shrub swamp</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Woodwardia virginica</i></span></td>
                    <td>
                        <span>Virginia chain fern</span></td>
                    <td>
              <span>Wetland herbaceous<sup>1</sup>, maritime
              swamp forest, maritime shrub swamp</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i><a href="../taxa/index.php?taxon=Yucca aloifoilia">Yucca aloifoilia</a></i></span></td>
                    <td>
                        <span>Spanish bayonet</span></td>
                    <td>
              <span>Understory<sup>1</sup>, maritime shrub,
              maritime evergreen forest, maritime deciduous forest, coastal
              fringe sandhill, coastal fringe evergreen forest</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Zamia pumila</i></span></td>
                    <td>
                        <span>Coontie, Florida arrowroot</span></td>
                    <td>
              <span>Understory<sup>2</sup>, maritime
              evergreen forest, maritime deciduous forest</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Zanthoxylum clava-herculis</i></span></td>
                    <td>
                        <span>Hercules club</span></td>
                    <td>
              <span>Canopy<sup>2</sup>, maritime shrub,
              maritime evergreen forest</span></td>
                </tr>
                <tr class="heading">
                    <td colspan="3">
                        <p class="label">Maritime Hammock Animals:</p>
                    </td>
                </tr>
                <tr>
                    <td>
                        <span><i>Accipiter cooperii</i></span></td>
                    <td>
                        <span>Cooper's hawk</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i>Accipiter striatus</i></span></td>
                    <td>
                        <span>Sharp-shinned hawk</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i>Actitis macularia</i></span></td>
                    <td>
                        <span>Spotted sandpiper</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i>Agkistrodon piscivorus</i></span></td>
                    <td>
                        <span>Cottonmouth</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i>Aix sponosa</i></span></td>
                    <td>
                        <span>Wood duck</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i>Anolis carolinensis carolinensis</i></span></td>
                    <td>
                        <span>Green anole</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i>Anolis sagrei</i></span></td>
                    <td>
                        <span>Brown anole</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i><a href="../taxa/index.php?taxon=Ardea herodias">Ardea herodias</a></i></span></td>
                    <td>
                        <span>Great blue heron</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i>Aythya collaris</i></span></td>
                    <td>
                        <span>Ring-necked duck</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i>Bubulcus ibis</i></span></td>
                    <td>
                        <span>Cattle egret</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i>Bucephala albeola</i></span></td>
                    <td>
                        <span>Bufflehead</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i>Buteo lineatus</i></span></td>
                    <td>
                        <span>Red-shouldered hawk</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i>Butorides virescens</i></span></td>
                    <td>
                        <span>Green heron</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i>Cardinalis cardinalis</i></span></td>
                    <td>
                        <span>Cardinal</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i><a href="../taxa/index.php?taxon=Cardisoma guanhumi">Cardisoma guanhumi</a></i></span></td>
                    <td>
                        <span>Land crab, blue land crab</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i><a href="../taxa/index.php?taxon=Ardea alba">Ardea alba</a></i></span></td>
                    <td>
                ...
                <tr>
                    <td>
                        <span><i>Cathartes aura</i></span></td>
                    <td>
                        <span>Turkey vulture</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i>Coccyzus americanus</i></span></td>
                    <td>
                        <span>Yellow-billed cuckoo</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i>Colaptes auratus</i></span></td>
                    <td>
                        <span>Common flicker</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i>Coluber constrictor paludicola</i></span>
                    </td>
                    <td>
                        <span>Everglades racer</span></td>
                    <td>
                        <span>Cape Canaveral region and Everglades</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Coluber constrictor priapus</i></span>
                    </td>
                    <td>
                        <span>Southern black racer</span></td>
                    <td>
                        <span>Throughout Florida</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Corvus brachyrhynchos</i></span></td>
                    <td>
                        <span>Common crow</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i>Corvus ossifragus</i></span></td>
                    <td>
                        <span>Fish crow</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i>Crotalus adamanteus</i></span></td>
                    <td>
                        <span>Eastern Diamondback rattlesnake</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i>Cryptotis parva</i></span></td>
                    <td>
                        <span>Least shrew</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i>Dendroica discolor</i></span></td>
                    <td>
                        <span>Prairie warbler</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i>Dendroica petechia</i></span></td>
                    <td>
                        <span>Yellow warbler</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i>Diadophis punctatus punctatus</i></span></td>
                    <td>
                        <span>Southern ring-neck snake</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i>Didelphis virginiana</i></span></td>
                    <td>
                        <span>Virginia oppossum</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i>Drymarchon corais couperi</i></span></td>
                    <td>
                        <span>Indigo snake</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i>Dumetella carolinensis</i></span></td>
                    <td>
                        <span>Gray catbird</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i><a href="../taxa/index.php?taxon=Egretta caerulea">Egretta caerulea</a></i></span></td>
                    <td>
                        <span>Little blue heron</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i><a href="../taxa/index.php?taxon=Egretta thula">Egretta thula</a></i></span></td>
                    <td>
                        <span>Snowy egret</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i><a href="../taxa/index.php?taxon=Egretta tricolor">Egretta tricolor</a></i></span></td>
                    <td>
                        <span>Louisiana heron, tricolored egret</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i>Elaphe guttata guttata</i></span></td>
                    <td>
                        <span>Corn snake</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i>Elaphe obsoleta quadrivittata</i></span></td>
                    <td>
                        <span>Yellow rat snake, chicken snake</span></td>
                    <td>
                        <span>Peninsular Florida</span></td>
                </tr>
                <tr>
                    <td>
                        <span><i>Eumeces inexpectatus</i></span></td>
                    <td>
                        <span>Southeastrn five-lined skink</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i>Felis catus</i></span></td>
                    <td>
                        <span>Domestic cat, house cat</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i>Frionyx ferox</i></span></td>
                    <td>
                        <span>Softshell turtle</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i>Fulica americana</i></span></td>
                    <td>
                        <span>American coot</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i>Gallinago gallinago</i></span></td>
                    <td>
                        <span>Common snipe</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i>Gallinula chloropus</i></span></td>
                    <td>
                        <span>Common gallinule</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i>Geothylpis frichas</i></span></td>
                    <td>
                        <span>Common yellowthroat</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i><a href="../taxa/index.php?taxon=Gopherus polyphemus">Gopherus polyphemus</a></i></span></td>
                    <td>
                        <span>Gopher tortoise</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i>Hemidactylu garnoti</i></span></td>
                    <td>
                        <span>Indo-Pacific gecko</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i>Hyla squirella</i></span></td>
                    <td>
                        <span>Squirrel treefrog</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i>Lampropeltis getulus</i></span></td>
                    <td>
                        <span>Eastern kingsnake</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i>Lasiurus borealis</i></span></td>
                    <td>
                        <span>Red bat</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i><a href="../taxa/index.php?taxon=Lontra canadensis">Lontra canadensis</a></i></span></td>
                    <td>
                        <span>River otter</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i>Lophodytes cucullatus</i></span></td>
                    <td>
                        <span>Hooded merganser</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i>Magaceryle alcyon</i></span></td>
                    <td>
                        <span>Belted kingisher</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i>Mus musculus</i></span></td>
                    <td>
                        <span>House mouse</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i>Myiarchus crinitus</i></span></td>
                    <td>
                        <span>Great crested flycatcher</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i>Neofiber alleni</i></span></td>
                    <td>
                        <span>Roundtailed muskrat</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i><a href="../taxa/index.php?taxon=Nerodia clarkii taeniata">Nerodia clarkii taeniata</a></i></span></td>
                    <td>
                        <span>Atlantic saltmash snake</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i><a href="../taxa/index.php?taxon=Nerodia fasciata taeniata">Nerodia fasciata taeniata</a></i></span></td>
                    <td>
                        <span>Atlantic saltmarsh snake</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i>Nycticorax nycticorax</i></span></td>
                    <td>
                        <span>Black-crowned night heron</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i>Nycticorax violaceus</i></span></td>
                    <td>
                        <span>Yellow-crowned night heron</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i>Odocoileus virginianus</i></span></td>
                    <td>
                        <span>White-tailed deer</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i>Opheodrys aestivus</i></span></td>
                    <td>
                        <span>Rough green snake</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i>Ophisaurus compressus</i></span></td>
                    <td>
                        <span>Island glass lizard</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i>Osteopilius septentrionalis</i></span></td>
                    <td>
                        <span>Cuban treefrog</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i>Otus asio</i></span></td>
                    <td>
                        <span>Screech owl</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i>Pandion haliaetus</i></span></td>
                    <td>
                        <span>Osprey</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i>Peromyscus gossypinus palarius</i></span></td>
                    <td>
                        <span>Cotton mouse</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i>Pipilo erythrophthalmus</i></span></td>
                    <td>
                        <span>Rufous-sided towhee</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i>Podilymbus podiceps</i></span></td>
                    <td>
                        <span>Pied-billed grebe</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i>Procyon lotor</i></span></td>
                    <td>
                ...
                <tr>
                    <td>
                        <span><i>Rallus elegans</i></span></td>
                    <td>
                        <span>King rail</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i>Rana sphenocephala</i></span></td>
                    <td>
                        <span>Southern leopard frog</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i>Rattus norvegicus</i></span></td>
                    <td>
                        <span>Norway rat</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i>Sciurus carolinensis</i></span></td>
                    <td>
                        <span>Gray squirrel</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i>Scolopax minor</i></span></td>
                    <td>
                        <span>American woodcock</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i>Sus scrofa</i></span></td>
                    <td>
                        <span>Wild boar</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i>Sylvilagus floridanus</i></span></td>
                    <td>
                        <span>Eastern cottontail</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i>Sylvilagus palustris</i></span></td>
                    <td>
                        <span>Marsh rabbit</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i>Thryothorus palustris</i></span></td>
                    <td>
                        <span>Marsh wren</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i>Turdus migratorius</i></span></td>
                    <td>
                        <span>American robin</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i>Vireo griseus</i></span></td>
                    <td>
                        <span>White-eyed vireo</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i>Vireo olivaceus</i></span></td>
                    <td>
                        <span>Red-eyed vireo</span></td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        <span><i>Zenaida macroura</i></span></td>
                    <td>
              <td>Mourning dove<br />
                    </td>
                    <td>&nbsp;</td>
            ...
            <table style="width:700px;margin-left:auto;margin-right:auto;">
                <tr>
                    <td><p class="body">
                            ...
                            <sup>4</sup> Found from Cape Canaveral to Ft. Pierce Inlet; to south is replaced with tropical shrubs and trees</font></p></td>
                </tr>
            </table>
            <br />
            <table style="width:700px;margin-left:auto;margin-right:auto;">
