...
<div id="innertext">
    ...
    <table style="border:0;width:700px;margin-left:auto;margin-right:auto;">
        <tr>
            <td align="center"><img border="0" src="../content/imglib/LagoonXS.jpg" width="497" height="197"><br/><br/>
            </td>
        </tr>
        <tr>
            <td><p class="body">
    ...
    <table style="border:0;width:700px;margin-left:auto;margin-right:auto;">
        <tr>
                    ...
                    <tr>
                        ...
                        <td valign="top">
                            <table width="200" border="0" class="image_left">
                                <tr>
                                    <th scope="row"><img border="0" src="../content/imglib/LS_Lagoon.jpg" class="body"
                                                         width="259" height="217"></th>
                                </tr>
                                <tr>
          ...
          estuary. Redrawn from Brown <i>et al</i>. 1989.</span></th>
                            ...
                            <p class="body">Many restricted lagoons like the
                ...
                <table style="border:0;width:700px;margin-left:auto;margin-right:auto;" cellpadding="5" cellspacing="5">
                    <tr>
                        <td valign="top">
                            <table width="200" border="0" class="image_left">
                                <tr>
                                    <td><img border="0" src="../content/imglib/LagoonSalin.gif" width="255"
                                             height="127"></td>
                                </tr>
                                <tr>
        	    ...
        	    IRL delimit 3 sub-basins.</span></td>
                            ...
                            <p class="body">It is important to note that although tidal forcing is important near
                                ...
                                in the interior of the Indian River Lagoon.</p>
                        </td>
                    </tr>
                </table>
                <br/>
