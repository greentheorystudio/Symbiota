	...
	<body>
		...
		<div id="innertext">
            ...
            <table style="border:0;width:700px;margin-left:auto;margin-right:auto;">
                <tr>
                    <td align="center"><img border="0" src="../content/imglib/LagoonXS.jpg" width="497" height="197"><br /><br /></td>
                </tr>
                <tr>
                    <td><p class="body">
                            ...
                            the lagoons. Because lagoons are characteristically shallow, they are strongly influenced by precipitation and
                            evaporation, which results in fluctuating water temperature and salinity. Lagoons can also be fragile ecosystems susceptible to pollution effects from municipal, industrial and agricultural
                            runoff.
                            Lagoons
                ...
                <tr>
                    <td><table style="width:700px;">
                            <tr>
                                ...
                                <td valign="top">
                                    <table width="200" border="0" class="image_left">
                                        <tr>
                                            <th scope="row"><img border="0" src="../content/imglib/LS_Lagoon.jpg" class="body" width="259" height="217"></th>
                                        </tr>
                                        <tr>
                                            <th scope="row"><span class="caption">A. Circulation patterns in a well mixed
          estuary. Redrawn from Brown <i>et al</i>. 1989.</span></th>
                                        </tr>
                                    </table><p class="body">Many restricted lagoons like the
                        ...
                        <table style="border:0;width:700px;margin-left:auto;margin-right:auto;" cellpadding="5" cellspacing="5">
                            <tr>
                                <td valign="top">
                                    <table width="200" border="0" class="image_left">
                                        <tr>
                                            <td><img border="0" src="../content/imglib/LagoonSalin.gif" width="255" height="127"></td>
                                        </tr>
                                        <tr>
                                            <td><span class="caption">B. Vertical profile of salinity in a well mixed estuary. Redrawn from Brown <i>et al</i>.
        	    1989.</span></td>
                                        </tr>
                                    </table>
                                    <p class="body">
                                        ...
                                        area north of Sebastian Inlet. <p></p></td>
                            </tr>
                        </table>
                        <table style="border:0;width:700px;margin-left:auto;margin-right:auto;" cellpadding="5" cellspacing="5">
                            <tr>
                                <td valign="top">
                                    <table width="200" border="0" class="image_left">
                                        <tr>
                                            <td><img border="0" src="../content/imglib/IRL_subbas.jpg" width="255"></td>
                                        </tr>
                                        <tr>
                                            <td><span class="caption">C. Inlets in the southern portion of the
        	    IRL delimit 3 sub-basins.</span></td>
                                        </tr>
                                    </table>
                                    <p class="body">
                                        ...
                                        maximum ebb or flood tides can exceed 1 m/sec<sup>-1</sup> due to the constricting
                                        effects of narrow inlet channels.</p>
                                    <p class="body">It is important to note that although tidal forcing is important near
                                        inlets mouths, volume transport in the interior of the Indian River Lagoon
                                        is principally a wind driven process (Pitts 1989 Smith 1990 Liu 1992). The shallow nature of coastal lagoons, combined
                                        with the constricting effects of inlets aid in decreasing tidal transport
                                        as distance from the inlet increases. Thus, wind becomes the primary transport process in the interior of the Indian River Lagoon.</p>
                                </td>
                            </tr>
                        </table>
                        <br />
