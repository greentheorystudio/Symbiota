	...
	<body>
		...
		<div id="innertext">
            ...
            <table cellpadding="5" cellspacing="3" style="border:0;width:700px;margin-left:auto;margin-right:auto;">
                <tr>
                    <td align="center"><img border="0" src="../content/imglib/Beach2.jpg" hspace="15" vspace="15" width="535"></td>
                </tr>
            </table>
            <br />
            ...
            <table style="border:0;width:700px;margin-left:auto;margin-right:auto;" cellpadding="5" cellspacing="5" class="table-border no-border alternate">
                <tr>
                    <th width="162">
                        Species Name</th>
                    <th width="157">
