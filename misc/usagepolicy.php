    ...
    <div style="margin:10px;">
        <ul>
            <li>
                ...
                of the data it publishes, the data are made available "as is". Any report of errors in the data should
                be
            ...
            <li>
                It is considered a matter of professional ethics to cite and acknowledge the work of other scientists
                that
            ...
            <li>
                <?php echo $DEFAULT_TITLE; ?> asks that users not redistribute data obtained from this site without
                permission for data owners.
