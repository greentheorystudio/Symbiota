	...
	<body>
		...
		<div id="innertext">
            ...
            <table style="border:0;width:700px;margin-left:auto;margin-right:auto;">
                <tr><td align="center"><img src="../content/imglib/Tidal_Flat_1.jpg" alt="" width="528" height="433" /><br />
            ...
            <table style="border:0;width:700px;margin-left:auto;margin-right:auto;">
                ...
                <tr><td>
                        <br />
                        <p class="body">Mudflats have higher organic loads than sandflats. Organic material may be derived from in situ production or come from adjacent coastal sources (salt marshes, mangrove forests, seagrass beds). Muddy systems are composed of sediments containing > 80 % silt and clay (particle size < 63 &micro;m) (Dyer 1979). Silts are fine inorganic particles held in suspension by slight water movement, while clay particles are colloids of hydrated aluminum silicate with iron and other impurities.</p>

                        <p class="body">Sediments of sandflats are comprised of larger, independent grains, mostly quartz (silica) derived from erosion. Sandy sediments can be divided into three size categories: 1) course (0.5 - 1.0 mm); medium (0.25 - 0.5 mm); and fine (0.063 - 0.25 mm). In southern Florida systems, mud-sand and combinations of coral rock (Ca CO3) soft-bottom types are common.The CaCO3 sediments of southeastern Florida are composed primarily of codacean algal plates (Myers and Ewel 1990).</p>
                    </td>
                </tr>
                <tr>
                    <td align="center">
                ...
                <tr>
                    <td><br />
                        <p class="body">
                            Trophic modes of bioturbators include filter feeding, deposit feeding and predation (Bertness 1999). Most bivalves are filter feeders and burrow into the sediment using their muscular foot. Bivalve shell sculpturing (ribbing) is thought to increase friction and burrowing efficiency (Stanley 1970). Filter feeding bivalves use their incurrent siphons to draw water into the body and pass it over the gills where tiny food particles such as diatoms, small zooplankton and detritus are extracted. Cilia then move the food toward the mouth. Water drawn in through the incurrent siphon also serves as a source of oxygen enabling the bivalve to respire. Filtered water, waste products and gametes are passed out into the water column through the excurrent siphon.</p>
                        <p class="body">Filter feeding bivalves on Indian River Lagoon tidal flats include the angelwing clam, Cyrtopleura costata (Fig. 8 A), the Atlantic giant cockle, Dinocardium robustum (Fig. 8 B),the southern hard clam, Mercenaria campechiensis, the hard clam, Mercenaria mercenaria, and the lucinid bivalve, Phacoides pectinata (Fig. 8 C) among others. These bivalves not only provide a vital trophic link between the water column and benthic production, but are also an important and abundant prey item of large, predatory, tidal flat species such as snails, crabs, fish and wading birds. </p></td></tr>
                <tr>
                    <td align="center">
                        <img src="../content/imglib/Tidal_Flat_8.jpg" width="544" height="127"><br>
                        <span class="caption">Fig. 8. Tidal flat bivalves: (A) Angelwing clam, <em>Cyrtopleura costata; </em>(B) Atlantic giant cockle, <em>Dinocardium robustum</em>; (C) the lucinid bivalve, <em>Phacoides pectinata</em>.</span></td></tr>
                <tr>
                    <td>
                        <br />
                        <p class="body">Filter feeding polychates include the parchment worm, Chaetopteris variopedatus (Fig. 9), noted for its tough membranous tube. It has developed paddles to pump water through the head and out the tail of its u-shaped burrow, thus effectively enabling the animal to rise above the redox potential discontinuity (RPD) (Little 2000). C variopedatus is abundant on IRL mud flats. </p></td></tr>
                <tr>
                    <td align="center">
                ...
                <tr>
                    <td><br />
                        <p class="body">The southern Indian River Lagoon supports an unusually high assemblage of infaunal decapod and stomatopod crustaceans (Felder and Manning 1986) that both filter and deposit feed. Two genera of thalassinidean shrimp, Callianassa (Fig. 10 A) - the ghost shrimp, and Upogebia - the mud shrimp, as well as the stomatopods Coronis excavatrix (Fig. 10 B), Lysiosquilla scabricauda and Lysiosquilla spp. are abundant macrobenthic crustaceans in the Inidan River Lagoon and are capable of extensive biotubation when constructing their elaborate, branching burrows. In the IRL, burrowing thalassinidean shrimp are represented by two species of Callianassa (C. guassutinga & C. rathbunae) and one species of Upogebia (U. affinis).</p>
                        <p class="body">Borrows have more than one entrance (Fig. 2 B) and shrimp are often found near an entrance pumping water into the burrow by beating their pleopods. These burrowing shrimp are considered to be both filter and deposit feeders with often one or the other trophic mode being more dominant, depending on the species (Coelho et al. 2000). Upogebiids generally feed on suspended material filtered from the water, while callianassids mainly feed on sediment taken up within the burrow by the second and third pereiopods. Both ghost and mud shrimp can have substantial effects on the abundance of co-occurring macro-infauna (Posey 1991). Commensals in the burrows of these infaunal shrimp may include polychaete worms, snapping shrimp and pea crabs.</p></td></tr>
                <tr>
                    <td align="center">
                ...
                <tr>
                    <td>
                        <br />
                        <p class="body">The burrowing, protobranch bivalve Macoma is also capable of both deposit and filter feeding. For example, in low flow situations, Macoma will remove sediment from the surface with its oral palps but will switch to filter feeding in high flow situations (Olafsson et al. 1994). Several species of Macoma are present in the IRL.</p>
                        <p class="body">Deposit feeders on tidal flats include surface deposit feeders that generally affect the upper 2 to 3 cm of sediment and burrowing deposit feeders whose effects on the sediments have deeper repercussions, i.e. up to 30 cm (Bertness 1999). Nonselective deposit feeders ingest both organic and sediment particles and then digest the organic material, e.g., bacteria growing on the sediment particles. Selective deposit feeders separate organic material from sediments prior to ingestion. Deposit feeders are an important link between the benthos and the sediment. They enhance sediment resuspension and nutrient exchange with the water column and increase productivity by increasing oxygen and nutrient levels in the benthos (Bertness 1999).</p>
                        <p class="body">Surface deposit feeders include mud snails, fiddler crabs, echinoderms, certain pelagic fish and shrimp. An abundant, deposit feeding fiddler crab on IRL mudflats is Uca pugilator (Fig. 11). Fiddler crabs form two types of characteristic pellets affecting sediment surface topography. The larger of the two pellets are formed during burrow excavation. Smaller pellets are formed during deposit feeding when the crab removes organic matter then rolls the remaining sediment into small balls and deposits them on the substratum. </p></td></tr>
                <tr><td align="center">
                        <img src="../content/imglib/Tidal_Flat_11.jpg" width="265" height="185"><br />
                        <span class="caption">Fig. 11. Fiddler crabs, <em>Uca pugilator</em>, on IRL mud flat.</span></td></tr>
                <tr>
                    <td>
                        <br />
                        <p class="body">The nine-armed starfish, <em><a href="../taxa/index.php?taxon=Luidia_senegalensis">Luidia senegalensis</a></em>, is a striking macrobenthic echinoderm in the IRL occurring on intertidal flats as well as subtidally. When buried, <em>L. senegalensis </em>(Fig. 12) will invert its stomach to feed on detritus (Hendler et al. 1995). Burrowing deposit feeders include polychaete and sipunculan worms (e. g., Siphonosoma cumanense, and Sipunculus nudus) (Rice 1995) bivalves and amphipods among others. The lugworm, <em>Arenicola cristata</em>, lives in extensive u-shaped tubes excavated in muddy tidal flat habitats. After sediment ingestion, the lugworm deposits large fecal casts at the posterior end of the burrow (Fig. 13). </p></td></tr>
                <tr><td align="center">
                ...
                <tr>
                    <td><br />
                        <p class="body">The ragged sea hare, Bursatella leachii, (Fig. 17) is a grazing benthic detritivore/herbivore that feeds primarily on cyanophytes and diatom mats and films found on sand, mud and other benthic substrata. These epibenthic species can have enormous effects on the abundance, diversity and distribution of microbenthic and infaunal tidal flat organisms and can also severely disturb the substratum while foraging for prey, e.g. the cow-nosed ray (Orth 1975). Early studies clearly demonstrated the effects of epibenthic predators on diminishing prey abundances with predator exclusion cage experiments (Virnstein 1977; Peterson 1979). Further experimentation has demonstrated a more complex picture of predator prey dynamics in soft bottom habitats particularly when interactions between and among infaunal and epibenthic predators as well as physical parameters of the habitat are considered (Quammen 1982, Ambrose 1984, Bottom 1984, Commito and Ambrose 1985, Thrush et al. 1997).</p></td></tr>
                <tr>
                    <td align="center">
            ...
            <table style="border:0;width:700px;margin-left:auto;margin-right:auto;" class="table-border no-border alternate">
                ...
                <tr>
                    <td><span><a href="../taxa/index.php?taxon=Acetabularia calyculus"><i>Acetabularia calyculus</i></a></span></td>
                ...
                <tr>
                    <td><span><i><a href="../taxa/index.php?taxon=Chaetopterus variopedatus">Chaetopterus variopedatus</a></i></span></td>
                ...
                <tr>
                    <td><span><i><a href="../taxa/index.php?taxon=Lysiosquilla scabricauda">Lysiosquilla scabricauda</a></i></span></td>
                ...
                <tr>
                    <td><span><i><a href="../taxa/index.php?taxon=Mercnaria campechiensis">Mercnaria campechiensis</a></i></span></td>
                ...
                <tr>
                    <td><span><i><a href="../taxa/index.php?taxon=Nerodia clarkii clarkii">Nerodia clarkii clarkii</a></i></span></td>
                    <td><span>Gulf salt marsh snake</span></td>
                </tr>
                <tr>
                    <td><span><i><a href="../taxa/index.php?taxon=Nerodia clarkii compressicauda">Nerodia clarkii compressicauda</a></i></span></td>
                ...
                <tr>
                    <td><span><i><a href="http://www.sms.si.edu/irlspec/Acipes_brevir">Acipenser brevirostrum</a></i></span></td>
                ...
                <tr>
                    <td><span><i><a href="../taxa/index.php?taxon=Carcharhinus limbatus">Carcharhinus limbatus</a></i></span></td>
                ...
                <tr>
                    <td><span><i><a href="../taxa/index.php?taxon=Paralichthys lethostigma">Paralichthys lethostigma</a></i></span></td>
                ...
                <tr>
                    <td><span><i><a href="../taxa/index.php?taxon=Calidris canutus rufa">Calidris canutus rufa</a></i></span></td>
                ...
                <tr>
                    <td><span><i><a href="../taxa/index.php?taxon=Pelecanus occidentalis">Pelecanus occidentalis</a></i></span></td>
            ...
            <table style="border:0;width:700px;margin-left:auto;margin-right:auto;">
                <tr>
                    <td><p class="title">REFERENCES
                            &amp; FURTHER READING</p>
                        <p class="body">Ambrose, W. G. 1984. Role of predatory infauna in structuring marine soft-bottom communities. Mar. Ecol. Prog. Ser. 17(2): 109-115.</p>
                        <p class="body">Amos, C. L. 1995. Siliciclastic tidal flats. In: Perillo, G. M. (Ed.), Geomorphology and Sedimentology of Estuaries. Elsevier, Amsterdam. pp. 273-306.</p>
                        <p class="body">Bell, S. and B. Coull 1978. Field evidence that shrimp predation regulates meiofauna. Oecologia 35: 141-148.</p>
                        <p class="body">Beyer, F. 1958. A new, bottom-living trachymedusa from the Oslo fjord. Nytt Mag. Zool. 6: 121-143.</p>
                        <p class="body">Bertness, M. D. 1999. The Ecology of Atlantic Shorelines. Sinauer Associates, Inc., Sunderland. 417 pp.</p>
                        <p class="body">Black, K. S., T. J. Tolhurst, S. E. Hagerthey and D. M. Paterson. 2002. Working with natural cohesive sediments. J. Hydraulic Eng. Forum 128: 1-7. </p>
                        <p class="body">Bottom, M. L. 1984. The importance of predation by horseshoe crabs, <em>Limulus polyphemus</em>, to an intertidal sand flat community. J. Mar. Res. 42: 139-161.</p>
                        <p class="body">Coelho, V. D., R. A. Cooper and S. Rodrigues. 2000. Burrow morphology and behavior of the mud shrimp <em>Upogebia omissa</em> (Decapoda: Thalassinidea: Upogebiidae). Mar. Ecol. Prog. Ser. 200: 229-240.</p>
                        <p class="body">Commito, J. A. and W. G. Ambrose. 1985. Multiple trophic levels in soft-bottom communities. Mar. Ecol. Prog. Ser. 26: 289-293.</p>
                        <p class="body">Coull, B. C. 2009. Role of meiofauna in estuarine soft-bottom habitats. Austral Ecol. 24(4): 327-343.</p>
                        <p class="body">de Brouwer, J. F. and L. J. Stal. 2001. Short-term dynamics in microphytobenthos distribution and associated extracellular carbohydrates in surface sediments of an intertidal mudflat. Mar. Ecol. Prog. Ser. 218: 33-44.</p>
                        <p class="body">Dyer, K. R. (Ed.), 1979. Estuarine Hydrography and Sedimentation. Estuarine and Brackish Water Sciences Association. Cambridge University Press, Cambridge. 230 pp.</p>
                        <p class="body">Dyer, K .R., M.C. Christe and E. W. Wright. 2000. The classification of mudflats. Cont. Shelf Res. 20: 1061-1078.</p>
                        <p class="body">Felder, D. L. and R. B. Manning. 1986. A new genus and two new species of Alpheid shrimps (Decapoda: Caridea) from south Florida. J. Crust. Biol. 6(3): 497-508.</p>
                        <p class="body">Giere, O. 2009. Meiobenthology. The microscopic motile fauna of aquatic sediments. Springer-Verlag, Berlin. 527 pp.</p>
                        <p class="body">Hendler G., J. E. Miller, D. L. Pawson , and P. M. Kier. 1995. Sea Stars, Sea Urchins, and Allies. Smithsonian Institution Press, Washington, D. C. 390 pp.</p>
                        <p class="body">Higgins, R. P. and H. Thiel. 1988. Introduction to the study of meiofauna. Smithsonian Institution Press, Washington, D. C. 488 pp.</p>
                        <p class="body">Holligan, P. M. and W. A. Reiners. 1992. Predicting the responses of the coastal zone to global change. Adv. Ecol. Res. 22: 211-215.</p>
                        <p class="body">Koulouri, P. Preliminary study of hyperbenthos in Heraklion Bay (Cretan Sea). Accessed 5 April 2010. Available at: http://www.biomareweb.org/3.6.html.</p>
                        <p class="body">Little, C. 2000. The Biology of Soft Shores and Estuaries. Oxford University Press, Oxford. 252 pp.</p>
                        <p class="body">MacIntyre, H. L., R. J. Geider and D. C. Miller. 1996. Microphytobenthos: the ecological role of the &ldquo;Secret Garden&rdquo; of unvegetated, shallow-water marine habitats. I. Distribution, abundance and primary production. Estuaries 19: 186-201.</p>
                        <p class="body">McIntyre, A. D. 1968. The macrofauna and meiofauna of some tropical beaches. J. Zool. 156: 377-392.</p>
                        <p class="body">Mees, J. and M. B. Jones. 1997. The hyperbenthos. Ocean. Mar. Biol.Ann. Rev.35: 221-255.</p>
                        <p class="body">Mitbavkar, S. and A. C. Anil. Diatoms of the microphytobenthic community: population structure in a tropical intertidal sand flat. Mar. Bio. 140: 41-57.</p>
                        <p class="body">Myers, R. L. and J. J. Ewel (Eds.), 1990. Ecosystems of Florida. U. of Central Florida Press, Orlando. 765 pp.</p>
                        <p class="body">Nielsen, C. 2001. Animal Evolution: Interrelationships of the Living Phyla. Oxford University Press, Oxford. 578 pp.</p>
                        <p class="body">Nybaken, J. W. and M. D. Bertness. 2005. Marine Biology: an Ecological Approach. Benjamin Cummings Publishers, San Francisco. 579 pp.</p>
                        <p class="body">Olafsson, E. B. , C. W. Peterson and W. G. Ambrose. 1994. Does recruitment limitation structure populations and communities of macro-invertebrates in marine soft sediments? The relative significance of pre- and post-settlement processes. Ocean. Mar. Biol. Ann. Rev. 32: 65-109.</p>
                        <p class="body">Orth, R. J. 1975. Destruction of eelgrass, <em>Zostera bonasus</em>, in Cesapeake Bay. Chesapeake Sci. 16: 205-208.</p>
                        <p class="body">Paterson, D. M., R. J. Aspden and K. S. Black. 2009. Intertidal flats: ecosystem functioning of soft sediment systems. In: Perillo, G. M., E. Wolanski, D. R. Cahoon and M. M. Brinson (Eds.), Coastal Wetlands An Integrated Approach. Elsevier, Amsterdam. Pp. 317-343.</p>
                        <p class="body">Peterson, C. H. 1979. Predation, competitive exclusion, and diversity in the soft-sediment benthic communities of estuaries and lagoons. In: Livingston, R. J. (Ed.), Ecological Processes in Coastal Marine Systems. Plenum Press, New York. 548 pp.</p>
                        <p class="body">Posey, M. H., B. R. Dumbauld and D. A. Armstrong. 1991. Effects of burrowing mud shrimp, <em>Upogebia pugettensis</em> (Dana), on abundances of macro-infauna. J. Exp. Mar. Biol. Ecol. 148: 283-294.</p>
                        <p class="body">Quammen, M. L. 1982. Influence of subtle substrate differences on feeding by shorebirds on intertidal mudflats. Mar. Biol. 71: 339-343.</p>
                        <p class="body">Rice, M. E., J. Piraino &amp; H. F. Reicherdt. 1995. A survey of the Sipunculaof the Indian River Lagoon. Bu.. Mar. Sci. 57(1): 128-135.</p>

                        <p class="body">Robertson, A. I. 1988 Decomposition of mangrove leaf litter in tropical Australia. J. Exp. Mar. Biol. Ecol. 116: 236-247.</p>
                        <p class="body">Ruiz, G. M., J. T. Carlton, E. D. Grosholz, and A. H. Hines. 1997. Global invasions of marine and estuarine habitats by non-indigenous species: mechanisms, extent, and consequences. Am. Zool. 37: 621-632.</p>

                        <p class="body">Schmalzer, P.A. 1995. Biodiversity of saline and brackish marshes of the Indian River Lagoon: historic and current patterns. Bull. Mar. Sci. 57(1): 37-48.</p>
                        <p class="body">Sibert, J. R. 1981. Intertidal hyperbenthic populations in the Nanaimo Estuary. Mar. Biol. 64: 259-265.</p>

                        <p class="body">Stal, L. J. 2003. Microphytobenthos, their extracellular polymeric substances, and the morphogenesis of intertidal sediments. Geomicrobio. J. 20 (5): 463-478.</p>
                        <p class="body">Stal, L. J. and F. C. de Brouwer. 2003. Biofilm formation by benthic diatoms and their influence on the stabilization of intertidal mudflats. Berichte -Forschungszentrum Terramare 12: 109-111.</p>
                        <p class="body">Stanley, S. M., 1970. Relation of shell form to life habits of the bivalve molluscs. Geol. Soc. Am. Monographs. 125: 1-296.</p>

                        <p class="body">Stutz, M. L. and O. H. Pilkey. 2002. Global distribution and morphology of deltaic barrier island systems. J. Coast. Res. 36: 694-707.</p>

                        <p class="body">Thrush, S. F., R. D. Pridmore, R. G. Bell, V. J. Cummings, P. K. Dayton, R. Ford, J. Grant, M. O. Green, J. E. Hewitt, A. H. Hines, M. T. Hume, S. M. Lawrie, P. Legendre, B. H. McArdle, D. Morrisey, D. C, Schneider, S. J. Turner, R. A. Walters, R. B. Whitlatch and M. R. Wilkinson. 1997. The sandflat habitat: scaling from experiments to conclusions. J. Exp. Mar. Biol. Ecol. 216: 1-9.</p>

                        <p class="body">Van der Wal, D., P. M. Herman, R. M. Forster, T. Ysebaret, F. Rossi, E. Knaeps, Y. M. Plancke and S. J. Ides. 2008. Distribution and dynamics of intertidal macrobenthos predicted from remote sensing: response to microphytobenthos and environment. Mar. Ecol. Prog. Ser. 367: 57-72.</p>

                        <p class="body">Virnstein, R. W. 1977. The importance of predation by crabs and fishes on benthic infauna in Chesapeake Bay. Ecol. 58: 1199-1217.</p>

                        <p class="body">Watzin, M. 1983. The effects of meiofauna on settling macrofauna: meiofauna may structure macrofaunal communities. Oecologia 59: 163-166.</p>

                        <p class="body">Winkler, G. and W. Greve. 2004. Trophodynamics of two interacting species of estuarine mysids, <em>Praunus flexuosus</em> and <em>Neomysis integer, </em>and their predation on the calanoid copepod <em>Eurytemora affinis. </em>J. Exp. Mar. Biol. Ecol. 308: 127-146.</p>
                    </td>
                </tr>
            </table>
