<script type="text/javascript">
    ...
    const GBIF_PUBLISHING_CONFIGURED = <?php echo ($GLOBALS['GBIF_PUBLISHING_CONFIGURED'] ? 'true' : 'false'); ?>;
    ...
    const taxonIdentifierApiUrl = CLIENT_ROOT + '/api/taxa/taxonIdentifierController.php';
