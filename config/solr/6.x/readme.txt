...
SOLR support was developed using Apache SOLR 6.2.1. Additional configurations may be required
...
9) Copy the files data-config.xml and schema.xml from [PORTAL BASE DIRECTORY]/config/solr/6.x to
...
12) Start your SOLR installation. Go to the SOLR admin panel at http://localhost:8983/solr/ and select your new core in the
    Core Selector drop down. Click on DataImport and then click the Execute button to initiate a full import.
