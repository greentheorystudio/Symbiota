...
<html lang="<?php echo $GLOBALS['DEFAULT_LANG']; ?>">
    ...
    <body>
        <div class="reveal">
            <div class="slides">
                <section id="search-criteria-panel" data-background-iframe="<?php echo $GLOBALS['CLIENT_ROOT']; ?>/spatial/index.php" data-background-interactive data-preload>
                    ...
                    <div class="topic-title-slide">
                        <div class="tutorial-frame topic-title-slide-inner">
                            ...
                            <div class="topic-nav-links">
                                <div><a href="side-panel.php">Previous Topic</a></div>
                                <div><a href="index.php#/index">Index of Topics</a></div>
                            </div>
                        </div>
                    </div>
                    <div class="tutorial-frame fragment fade-in-then-out topic-content-slide">
                        <p>The Search Criteria Panel is accessed by opening the <a href="side-panel.php#/side-panel/0">Side Panel</a> and
                    ...
                    <div class="tutorial-frame fragment fade-in-then-out topic-content-slide">
                        <p>The Search Criteria Panel has two tabs: Criteria and Collections, each with a Reset button, to reset
                            ...
                            on any criteria entered or selected in either tab, and/or features that may be <a href="working-with-shapes-layer.php#/working-with-shapes-layer/2">selected in the Shapes Layer</a>.</p>
                    </div>
                    <div class="tutorial-frame fragment fade-in-then-out topic-content-slide">
                        <h3><a href="loading-occurrence-records.php">Go To Next Topic</a></h3>
                    </div>
                </section>
            </div>
        </div>
