...
<body>
    <div class="reveal">
        <div class="slides">
            <section id="raster-tools-panel" data-background-iframe="<?php echo $GLOBALS['CLIENT_ROOT']; ?>/spatial/index.php" data-background-interactive data-preload>
                ...
                <div class="topic-title-slide">
                    <div class="tutorial-frame topic-title-slide-inner">
                        ...
                        <div class="topic-nav-links">
                            <div><a href="convex-hull-polygon-tool.php">Previous Topic</a></div>
                            <div><a href="index.php#/index">Index of Topics</a></div>
                        </div>
                    </div>
                </div>
                <div class="tutorial-frame fragment fade-in-then-out topic-content-slide">
                    <p>The Raster Tools Panel is accessed by opening the <a href="side-panel.php#/side-panel/0">Side Panel</a> and
                ...
                <div class="tutorial-frame fragment fade-in-then-out topic-content-slide">
                    <h3><a href="data-vectorize-tool.php">Go To Next Topic</a></h3>
                </div>
            </section>
        </div>
    </div>
