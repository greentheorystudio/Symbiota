...
<html lang="<?php echo $GLOBALS['DEFAULT_LANG']; ?>">
    ...
    <body>
        <div class="reveal">
            <div class="slides">
                <section id="walkthrough-4" data-background-iframe="../../spatial/index.php" data-background-interactive data-preload>
                    ...
                    <div class="tutorial-frame fragment fade-in-then-out topic-content-slide">
                        <h3>Step 10</h3>
                        <p>Drag and drop the file downloaded in step 2 over the map to load the Bailey's Ecoregion data onto the map.</p>
                    </div>
                    <div class="tutorial-frame fragment fade-in-then-out topic-content-slide">
                        <h3>Step 11</h3>
