...
<body>
    <div class="reveal">
        <div class="slides">
            <section id="side-panel" data-background-iframe="<?php echo $GLOBALS['CLIENT_ROOT']; ?>/spatial/index.php" data-background-interactive data-preload>
                ...
                <div class="topic-title-slide">
                    <div class="tutorial-frame topic-title-slide-inner">
                        ...
                        <div class="topic-nav-links">
                            <div><a href="working-with-shapes-layer.php">Previous Topic</a></div>
                            <div><a href="index.php#/index">Index of Topics</a></div>
                        </div>
                    </div>
                </div>
                <div class="tutorial-frame fragment fade-in-then-out topic-content-slide">
                    <p>The Side Panel is accessed by clicking on the <a href="main-map-window.php#/main-map-window/1">Side Panel Toggle</a>. Once
                ...
                <div class="tutorial-frame fragment fade-in-then-out topic-content-slide">
                    <h3><a href="search-criteria-panel.php">Go To Next Topic</a></h3>
                </div>
            </section>
        </div>
    </div>
