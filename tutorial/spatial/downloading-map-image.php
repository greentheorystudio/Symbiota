...
<body>
    <div class="reveal">
        <div class="slides">
            <section id="downloading-map-image" data-background-iframe="<?php echo $GLOBALS['CLIENT_ROOT']; ?>/spatial/index.php" data-background-interactive data-preload>
                ...
                <div class="topic-title-slide">
                    <div class="tutorial-frame topic-title-slide-inner">
                        ...
                        <div class="topic-nav-links">
                            <div><a href="using-heat-map-display.php">Previous Topic</a></div>
