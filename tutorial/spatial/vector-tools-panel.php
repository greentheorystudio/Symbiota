...
<body>
    <div class="reveal">
        <div class="slides">
            <section id="vector-tools-panel" data-background-iframe="<?php echo $GLOBALS['CLIENT_ROOT']; ?>/spatial/index.php" data-background-interactive data-preload>
                ...
                <div class="tutorial-frame fragment fade-in-then-out topic-content-slide">
                    <p>The Vector Tools Panel is accessed by opening the <a href="side-panel.php#/side-panel/0">Side Panel</a> and
                ...
                <div class="tutorial-frame fragment fade-in-then-out topic-content-slide">
                    <h3><a href="shapes-tab.php">Go To Next Topic</a></h3>
                </div>
            </section>
        </div>
    </div>
