...
<html lang="<?php echo $GLOBALS['DEFAULT_LANG']; ?>">
    ...
    <body>
        <div class="reveal">
            <div class="slides">
                <section id="intro" data-background-iframe="../../../admin/mapping/index.php" data-background-interactive data-preload>
                ...
                <section id="index" data-background-iframe="../../../admin/mapping/index.php" data-preload>
                ...
                <section data-background-iframe="../../../admin/mapping/index.php" data-background-interactive data-preload>
                    <div style="position:absolute;left: 50%; bottom:20%; width:40%;">
                        <div class="tutorial-frame" style="position:relative;left: -50%;">
