...
?>
<head>
	<title><?php echo $GLOBALS['DEFAULT_TITLE']; ?> Voucher Query Builder</title>
    <meta name="description" content="Build occurrence query to find checklist voucher records">
