...
<html lang="<?php echo $GLOBALS['DEFAULT_LANG']; ?>">
    ...
    <body>
        ...
        <div id="mainContainer">
            ...
            <template v-if="showChecklistTaxaEditorPopup">
                <checklist-taxa-editor-popup
                    ...
                    @load:checklist-taxa="setChecklistTaxa();"
                ></checklist-taxa-editor-popup>
            </template>
        ...
        <script src="<?php echo $GLOBALS['CLIENT_ROOT']; ?>/components/checklists/checklistTaxaBatchLoaderModule.js?ver=<?php echo $GLOBALS['JS_VERSION']; ?>" type="text/javascript"></script>
                    ...
                    const activeTaxaArr = Vue.computed(() => {
                        ...
                        taxaDataArr.value.forEach(taxon => {
                            ...
                            if(taxonFilterVal.value){
                                if(Number(taxonFilterVal.value['rankid']) > 0){
                                ...
                                else if(taxon.hasOwnProperty('vernacularData') && taxon['vernacularData'] && taxon['vernacularData'].length > 0){
                                    const vernacularMatch = taxon['vernacularData'].find(vernacular => vernacular['vernacularname'] === taxonFilterVal.value['sciname']);
                                    if(vernacularMatch){
                                        includeTaxon = true;
                                    }
                                }
