...
<body>
    ...
    <div id="mainContainer" style="padding: 10px 15px 15px;">
        <div class="q-mt-md row justify-evenly q-gutter-md">
            <a class="col-12 col-sm-6 col-md-4 col-lg-3" href="/misc/getting-started.php" tabindex="0">
                <q-card bordered>
            ...
            <a class="col-12 col-sm-6 col-md-4 col-lg-3" href="/taxa/index.php?taxon=3204" tabindex="0">
                <q-card bordered>
                    <q-card-section class="column items-center">
                        <q-resize-observer @resize="setImageSize"></q-resize-observer>
            ...
            <a class="col-12 col-sm-6 col-md-4 col-lg-3" href="https://naturalhistory.us18.list-manage.com/subscribe?u=f1cbc7232ea2938e9252c5886&id=9ca1d0073b" target="_blank" aria-label="External link: Newsletter signup - Opens in separate tab" tabindex="0">
                <q-card bordered>
                    <q-card-section class="column items-center">
                        <q-resize-observer @resize="setImageSize"></q-resize-observer>
        ...
        <div class="q-mt-md row justify-evenly q-gutter-md">
            <q-card class="col-12 col-sm-6 col-md-4 col-lg-3" bordered>
        ...
        const homePageModule = Vue.createApp({
            setup() {
                ...
                function setImageSize(cardSize) {
                    imageWidth.value = (cardSize.width - 75) + 'px';
                }
