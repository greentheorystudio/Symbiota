                    ...
                    <template v-if="imageArr.length > 0">
                        <div class="q-mt-sm column q-gutter-sm">
                            ...
                            <template v-for="image in imageArr">
                                <image-record-info-block :image-data="image" :editor="true" @image:updated="processMediaUpdate" @open:image-editor="openImageEditorPopup"></image-record-info-block>
                            </template>
                        </div>
                    </template>
                    <template v-if="mediaArr.length > 0">
                        <div class="q-mt-sm column q-gutter-sm">
                            ...
                            <template v-for="media in mediaArr">
                                <media-record-info-block :media-data="media" :editor="true" @media:updated="processMediaUpdate" @open:media-editor="openMediaEditorPopup"></media-record-info-block>
                            </template>
                        </div>
                    </template>
                </template>
