                    ...
                    <q-card-section>
                        ...
                        <div class="processor-tool-control-container">
                            ...
                            <div class="processor-tool-button-container">
                                <div>
                                    <q-btn :loading="currentProcess === 'setUpdateFamilies'" :disabled="currentProcess && currentProcess !== 'setUpdateFamilies'" color="secondary" @click="initializeSetUpdateFamilies('setUpdateFamiliesAccepted');" label="Start" dense aria-label="Start Set Family Names" tabindex="0" />
                                </div>
                                <div>
                                    <q-btn v-if="currentProcess === 'setUpdateFamilies'" :disabled="processCancelling && currentProcess === 'setUpdateFamilies'" color="red" @click="cancelProcess();" label="Cancel" dense aria-label="Cancel Set Family Names" tabindex="0" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="processor-tool-control-container">
                            ...
                            <div class="processor-tool-button-container">
                                <div>
                                    <q-btn :loading="currentProcess === 'removeUnacceptedTaxa'" :disabled="currentProcess && currentProcess !== 'removeUnacceptedTaxa'" color="secondary" @click="initializeRemoveUnacceptedTaxa();" label="Start" dense aria-label="Start Remove Unaccepted Taxa" tabindex="0" />
                                </div>
                                <div>
                                    <q-btn v-if="currentProcess === 'removeUnacceptedTaxa'" :disabled="processCancelling && currentProcess === 'removeUnacceptedTaxa'" color="red" @click="cancelProcess();" label="Cancel" dense aria-label="Cancel Remove Unaccepted Taxa" tabindex="0" />
                                </div>
                            </div>
                        </div>
                        <q-separator size="1px" color="grey-8" class="q-ma-md"></q-separator>
                        ...
                        <div class="processor-tool-control-container">
                            ...
                            <div class="processor-tool-button-container">
                                <div>
                                    <q-btn :loading="currentProcess === 'removeTaxaByRank'" :disabled="currentProcess && currentProcess !== 'removeTaxaByRank'" color="secondary" @click="initializeRemoveTaxaByRank();" label="Start" dense aria-label="Start Remove Taxa By Rank" tabindex="0" />
                                </div>
                                <div>
                                    <q-btn v-if="currentProcess === 'removeTaxaByRank'" :disabled="processCancelling && currentProcess === 'removeTaxaByRank'" color="red" @click="cancelProcess();" label="Cancel" dense aria-label="Cancel Remove Taxa By Rank" tabindex="0" />
                                </div>
                            </div>
                        </div>
                        <q-separator size="1px" color="grey-8" class="q-ma-md"></q-separator>
                        ...
                        <div class="processor-tool-control-container">
                            ...
                            <div class="processor-tool-button-container">
                                <div>
                                    <q-btn :loading="currentProcess === 'removeTaxa'" :disabled="currentProcess && currentProcess !== 'removeTaxa'" color="secondary" @click="initializeRemoveTaxa();" label="Start" dense aria-label="Start Remove Taxa" tabindex="0" />
                                </div>
                                <div>
                                    <q-btn v-if="currentProcess === 'removeTaxa'" :disabled="processCancelling && currentProcess === 'removeTaxa'" color="red" @click="cancelProcess();" label="Cancel" dense aria-label="Cancel Remove Taxa" tabindex="0" />
                                </div>
                            </div>
                        </div>
                        <q-separator size="1px" color="grey-8" class="q-ma-md"></q-separator>
                        ...
                        <div class="processor-tool-control-container">
                            ...
                            <div class="processor-tool-button-container">
                                <div>
                                    <q-btn :loading="currentProcess === 'rebuildHierarchy'" :disabled="currentProcess && currentProcess !== 'rebuildHierarchy'" color="secondary" @click="initializeRebuildHierarchy();" label="Start" dense aria-label="Start Rebuild Taxonomic Hierarchy" tabindex="0" />
                                </div>
                                <div>
                                    <q-btn v-if="currentProcess === 'rebuildHierarchy'" :disabled="processCancelling && currentProcess === 'rebuildHierarchy'" color="red" @click="cancelProcess();" label="Cancel" dense aria-label="Cancel Rebuild Taxonomic Hierarchy" tabindex="0" />
                                </div>
                            </div>
                        </div>
                        <q-separator size="1px" color="grey-8" class="q-ma-md"></q-separator>
                        ...
                        <div class="processor-tool-control-container">
                            ...
                            <div class="processor-tool-button-container">
                                <div>
                                    <q-btn :loading="currentProcess === 'formatCommonNames'" :disabled="currentProcess && currentProcess !== 'formatCommonNames'" color="secondary" @click="initializeFormatCommonNames();" label="Start" dense aria-label="Start Format Common Names" tabindex="0" />
                                </div>
                                <div>
                                    <q-btn v-if="currentProcess === 'formatCommonNames'" :disabled="processCancelling && currentProcess === 'formatCommonNames'" color="red" @click="cancelProcess();" label="Cancel" dense aria-label="Cancel Format Common Names" tabindex="0" />
                                </div>
                            </div>
                        </div>
                        <q-separator size="1px" color="grey-8" class="q-ma-md"></q-separator>
                        ...
                        <div class="processor-tool-control-container">
                            ...
                            <div class="processor-tool-button-container">
                                <div>
                                    <q-btn :loading="currentProcess === 'removeCommonNames'" :disabled="currentProcess && currentProcess !== 'removeCommonNames'" color="secondary" @click="initializeRemoveCommonNames();" label="Start" dense aria-label="Start Remove Common Names" tabindex="0" />
                                </div>
                                <div>
                                    <q-btn v-if="currentProcess === 'removeCommonNames'" :disabled="processCancelling && currentProcess === 'removeCommonNames'" color="red" @click="cancelProcess();" label="Cancel" dense aria-label="Cancel Remove Common Names" tabindex="0" />
                                </div>
                            </div>
                        </div>
                        <q-separator size="1px" color="grey-8" class="q-ma-md"></q-separator>
                                                ...
                                                <template v-if="subproc.type === 'text' || subproc.type === 'undo'">
                                                    ...
                                                    <template v-if="!subproc.loading && subproc.resultText">
                                                        ...
                                                        <div v-if="subproc.result === 'success' && subproc.type === 'undo'" class="q-ml-sm text-weight-bold text-green-9">
                                                            {{subproc.resultText}} <q-btn :disabled="undoButtonsDisabled" class="q-ml-md text-grey-9" color="warning" size="sm" @click="undoChangedSciname(proc.id,subproc.undoOrigName,subproc.undoChangedName);" label="Undo" dense tabindex="0" />
                                                        </div>
                                                ...
                                                <template v-if="subproc.type === 'fuzzy'">
                                                    <template v-if="subproc.procText === 'skip'">
                                                        <div class="q-mx-xl q-my-sm row justify-between">
                                                            <div></div>
                                                            <div>
                                                                <q-btn :disabled="!(currentTaxon.sciname === proc.id)" class="q-ml-md" color="primary" size="sm" @click="runTaxThesaurusFuzzyMatchProcess();" label="Skip Taxon" dense tabindex="0" />
                                                            </div>
                                                        </div>
                                                    </template>
                                                    <template v-else>
                                                        <div class="q-mx-xl q-my-sm row justify-between">
                                                            ...
                                                            <div>
                                                                <q-btn :disabled="!(currentTaxon.sciname === proc.id)" class="q-ml-md" color="primary" size="sm" @click="selectFuzzyMatch(subproc.undoOrigName,subproc.undoChangedName,subproc.changedTid);" label="Select" dense tabindex="0" />
                                                            </div>
                                                        </div>
                                                    </template>
                                                </template>
