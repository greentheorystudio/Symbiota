const occurrenceProcessingStatusSelector = {
    props: {
        definition: {
            type: Object,
            default: null
    ...
    setup(props, context) {
        ...
        const selectorOptions = Vue.computed(() => baseStore.getOccurrenceProcessingStatusOptions);
        ...
        function setSelectedOption() {
            selectedOption.value = selectorOptions.value.find(opt => opt === props.value);
        }
