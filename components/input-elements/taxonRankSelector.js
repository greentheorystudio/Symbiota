const taxonRankSelector = {
    ...
    template: `
        <q-select v-model="selectedOption" outlined dense options-dense input-debounce="500" bg-color="white" popup-content-class="z-top" behavior="menu" input-class="z-top" :options="rankOptions" option-value="rankid" option-label="rankname" :label="label" @update:model-value="processChange" :tabindex="tabindex" :readonly="disabled">
