                            ...
                            <q-card v-for="collection in collectionArr">
                                <q-card-section class="q-pa-md column">
                                    <div v-if="duplicateDisplay" class="q-mb-xs row justify-end">
                                        <q-btn role="link" color="grey-4" text-color="black" class="black-border" size="sm" :href="(clientRoot + '/collections/occurrenceNavigator.php?interface=occurrence&occid=' + collection.occid + '&collid=' + collection.collid)" target="_blank" icon="fas fa-edit" dense aria-label="View in occurrence editor - Opens in separate tab" tabindex="0">
