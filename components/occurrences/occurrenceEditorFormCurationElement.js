            ...
            <q-card-section class="q-pa-sm column q-col-gutter-sm">
                ...
                <div v-if="!editorHideFields.includes('occurrenceid') || !editorHideFields.includes('language') || !editorHideFields.includes('processingstatus')" class="row justify-between q-col-gutter-sm">
                    ...
                    <div v-if="!editorHideFields.includes('language')" class="col-12 col-sm-6 col-md-3">
                        <text-field-input-element :definition="occurrenceFieldDefinitions['language']" label="Language" field="language" :maxlength="occurrenceFields['language'] ? occurrenceFields['language']['length'] : 0" :value="occurrenceData.language" @update:value="(value) => updateOccurrenceData('language', value)"></text-field-input-element>
                    </div>
                ...
                <div v-if="!editorHideFields.includes('preparations') || !editorHideFields.includes('disposition') || !editorHideFields.includes('duplicatequantity')" class="row justify-between q-col-gutter-sm">
                    <div v-if="!editorHideFields.includes('preparations')" class="col-12 col-sm-6 col-md-5">
                        ...
                        <template v-else>
                            <text-field-input-element :definition="occurrenceFieldDefinitions['preparations']" label="Preparations" field="preparations" :maxlength="occurrenceFields['preparations'] ? occurrenceFields['preparations']['length'] : 0" :value="occurrenceData.preparations" @update:value="(value) => updateOccurrenceData('preparations', value)"></text-field-input-element>
                        </template>
                    </div>
                    <div v-if="!editorHideFields.includes('disposition')" class="col-12 col-sm-6 col-md-4">
                        <text-field-input-element :definition="occurrenceFieldDefinitions['disposition']" label="Disposition" field="disposition" :maxlength="occurrenceFields['disposition'] ? occurrenceFields['disposition']['length'] : 0" :value="occurrenceData.disposition" @update:value="(value) => updateOccurrenceData('disposition', value)"></text-field-input-element>
                    </div>
                ...
                <div v-if="!editorHideFields.includes('institutioncode') || !editorHideFields.includes('collectioncode') || !editorHideFields.includes('ownerinstitutioncode')" class="row justify-between q-col-gutter-sm">
                    <div v-if="!editorHideFields.includes('institutioncode')" class="col-12 col-sm-6 col-md-4">
                        <text-field-input-element :definition="occurrenceFieldDefinitions['institutioncode']" label="Institution Code" field="institutioncode" :maxlength="occurrenceFields['institutioncode'] ? occurrenceFields['institutioncode']['length'] : 0" :value="occurrenceData.institutioncode" @update:value="(value) => updateOccurrenceData('institutioncode', value)"></text-field-input-element>
                    </div>
                    <div v-if="!editorHideFields.includes('collectioncode')" class="col-12 col-sm-6 col-md-4">
                        <text-field-input-element :definition="occurrenceFieldDefinitions['collectioncode']" label="Collection Code" field="collectioncode" :maxlength="occurrenceFields['collectioncode'] ? occurrenceFields['collectioncode']['length'] : 0" :value="occurrenceData.collectioncode" @update:value="(value) => updateOccurrenceData('collectioncode', value)"></text-field-input-element>
                    </div>
                    <div v-if="!editorHideFields.includes('ownerinstitutioncode')" class="col-12 col-sm-6 col-md-4">
                        <text-field-input-element :definition="occurrenceFieldDefinitions['ownerinstitutioncode']" label="Owner Institution Code" field="ownerinstitutioncode" :maxlength="occurrenceFields['ownerinstitutioncode'] ? occurrenceFields['ownerinstitutioncode']['length'] : 0" :value="occurrenceData.ownerinstitutioncode" @update:value="(value) => updateOccurrenceData('ownerinstitutioncode', value)"></text-field-input-element>
                    </div>
                </div>
                <div v-if="!editorHideFields.includes('datageneralizations')" class="row">
                    <div class="col-grow">
                        <text-field-input-element data-type="textarea" :definition="occurrenceFieldDefinitions['datageneralizations']" label="Data Generalizations" field="datageneralizations" :maxlength="occurrenceFields['datageneralizations'] ? occurrenceFields['datageneralizations']['length'] : 0" :value="occurrenceData.datageneralizations" @update:value="(value) => updateOccurrenceData('datageneralizations', value)"></text-field-input-element>
                    </div>
                </div>
            </q-card-section>
        </q-card>
