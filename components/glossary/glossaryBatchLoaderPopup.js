                                        ...
                                        <q-card class="q-my-sm" flat bordered>
                                            <q-card-section>
                                                <div class="q-pa-md column q-col-gutter-sm">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-grow">
                                                            <multiple-scientific-common-name-auto-complete label="Enter Taxonomic Groups" :sciname-arr="taxonomicGroupVal" :limit-to-options="true" :accepted-taxa-only="true" :name-string-mode="false" @update:sciname="processScientificNameChange"></multiple-scientific-common-name-auto-complete>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-grow">
