                            ...
                            <q-card-section>
                                ...
                                <div class="q-mt-xs q-pl-sm column">
                                    ...
                                    <div class="cursor-pointer">
                                        <a role="button" @click="updateCollectionStatistics()" @keyup.enter="updateCollectionStatistics()" tabindex="0">
                                            Update Statistics
                                        </a>
                                    </div>
                    ...
                    <q-card flat bordered>
                        <q-card-section>
                            ...
                            <div class="q-mt-xs q-pl-sm column">
                                ...
                                <div class="q-mt-sm">
                                    <a :href="(clientRoot + '/collections/occurrenceNavigator.php?interface=occurrence&gotomode=1&collid=' + collectionId)" tabindex="0">
