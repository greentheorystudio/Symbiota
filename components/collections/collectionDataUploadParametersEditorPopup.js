                    ...
                    <div :style="contentStyle" class="overflow-auto">
                        <div class="q-pa-md column q-col-gutter-sm">
                            <div class="row justify-between">
                                ...
                                <div class="row justify-end">
                                    <template v-if="collectionDataUploadParametersId > 0">
                                        <q-btn color="secondary" @click="saveCollectionDataUploadParametersEdits();" label="Save Edits" :disabled="!editsExist || !profileDataValid" />
                                    </template>
                                    <template v-else>
                                        <q-btn color="secondary" @click="addCollectionDataUploadParameters();" label="Add Profile" :disabled="!profileDataValid" />
                                    </template>
                                </div>
                            </div>
                            ...
                            <div v-if="Number(collectionDataUploadParametersId) > 0" class="row justify-end q-gutter-md">
                                <div>
                                    <q-btn color="negative" @click="deleteCollectionDataUploadParameters();" label="Delete Profile" />
                                </div>
                            </div>
                        </div>
                    </div>
