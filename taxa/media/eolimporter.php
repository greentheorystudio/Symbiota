...
<body>
    ...
    <div id="innertext">
        ...
        if($isEditor){
            ...
            <div id="module-header" style="display:flex;justify-content: space-between;margin-bottom:8px;">
                <div onclick="openTutorialWindow('../../tutorial/collections/management/taxonomy/index.php');" title="Open Tutorial Window">
            ...
            <div class="processor-container">
                <div id="processor-accordion" class="processor-control-container">
                    <q-card>
                        <q-list>
    ...
    ?>
    <script src="../../components/test.js" type="text/javascript"></script>
    <script>
