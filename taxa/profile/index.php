        ...
        <div id="mainContainer">
            ...
            <div v-if="isTaxonProfileEditor" class="q-pa-md">
                ...
                <template v-if="Number(taxon['tid']) > 0">
                    <q-card>
                        <div class="q-pa-sm row justify-between q-gutter-x-sm">
                            <div class="q-pl-sm">
                                <span class="taxon-profile-sciname"><span class="species">{{ taxon.sciname + ' ' }}</span></span>
                        ...
                        <q-tabs v-model="tab" class="q-px-sm q-pt-sm" content-class="bg-grey-3" active-bg-color="grey-4" align="left">
                            ...
                            <q-tab name="tag" label="Tag Primary Image" no-caps></q-tab>
